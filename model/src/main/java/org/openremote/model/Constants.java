...
public interface Constants {
    ...
    String UNITS_DISTANCE_M = "METRES";
    String UNITS_DISTANCE_CM = "CENTIMETRES";
    String UNITS_DISTANCE_MM = "MILLIMETRES";
    ...
    String UNITS_KILOWATT_PER_HOUR = "KW_PER_HOUR";
    ...
    String UNITS_ANGLE_DEGREES_MINS_SECONDS = "ANGLE_DMS";
}
