...
public class AlarmAssetLink {
    ...
    @Formula("(select a.NAME from ASSET a where a.ID = ASSET_ID and a.DELETED_ON is null)")
    protected String assetName;

    @Formula("(select pa.NAME from ASSET a left outer join ASSET pa on a.PARENT_ID = pa.ID and pa.DELETED_ON is null where a.ID = ASSET_ID and a.DELETED_ON is null)")
