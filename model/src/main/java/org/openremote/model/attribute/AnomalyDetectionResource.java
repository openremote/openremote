...
@Path("asset/anomalydetection")
public interface AnomalyDetectionResource {
    /**
     * Retrieve the anomaly datapoint limits of an asset attribute. Regular users can only access assets in their
