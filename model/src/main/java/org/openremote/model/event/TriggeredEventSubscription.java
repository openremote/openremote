...
public class TriggeredEventSubscription<T extends SharedEvent> {
  ...
  public static class TriggeredEventSubscriptionSerializer
      extends StdSerializer<TriggeredEventSubscription> {
    ...
    public void serialize(
        TriggeredEventSubscription value, JsonGenerator gen, SerializationContext context)
      ...
      if (value.events != null) {
        for (Object event : value.events) {
          ...
          if (event instanceof SharedEvent sharedEvent
              && eventNode instanceof ObjectNode objectNode) {
  ...
  public static class TriggeredEventSubscriptionDeserializer
      extends StdDeserializer<TriggeredEventSubscription> {
    ...
    public TriggeredEventSubscription deserialize(JsonParser p, DeserializationContext ctxt)
        throws JacksonException {
      ...
      return new TriggeredEventSubscription(
          events,
          subscriptionIdNode != null && !subscriptionIdNode.isNull()
              ? subscriptionIdNode.asText()
              : null);
    }
  }
  ...
  @JsonCreator
  public TriggeredEventSubscription(
