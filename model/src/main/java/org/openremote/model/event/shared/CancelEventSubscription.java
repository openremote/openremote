...
/**
 * A client can unsubscribe from {@link SharedEvent}s on the server, providing the type of event it
 * doesn't want to receive anymore or the subscription ID to remove a specific subscriber.
 */
public class CancelEventSubscription {
  ...
  public <E extends SharedEvent> CancelEventSubscription(
      Class<E> eventClass, String subscriptionId) {
