...
/**
 * A consumer can subscribe to {@link Event}s on the server, providing the type of event it wants to
 * receive as well as filter criteria to restrict the events to an interesting subset.
 *
 * <p>A subscription can optionally contain a {@link #subscriptionId} which allows a client to have
 * multiple subscriptions for the same event type.
 */
...
public class EventSubscription<E extends Event> {
  ...
  public static class EventSubscriptionSerializer extends StdSerializer<EventSubscription> {
    ...
    @Override
    public void serialize(EventSubscription value, JsonGenerator gen, SerializationContext context)
  ...
  public static class EventSubscriptionDeserializer extends StdDeserializer<EventSubscription> {
    ...
    @Override
    public EventSubscription deserialize(JsonParser p, DeserializationContext ctxt)
        throws JacksonException {
  ...
  @JsonIgnore protected boolean subscribed;
