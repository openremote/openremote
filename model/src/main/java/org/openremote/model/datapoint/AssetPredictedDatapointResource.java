...
public interface AssetPredictedDatapointResource {
    ...
    ValueDatapoint<?>[] getPredictedDatapoints(@BeanParam RequestParams requestParams,
            @PathParam("assetId") String assetId, @PathParam("attributeName") String attributeName,
    ...
    void writePredictedDatapoints(@BeanParam RequestParams requestParams, @PathParam("assetId") String assetId,
            @PathParam("attributeName") String attributeName, ValueDatapoint<?>[] predictedDatapoints);
}
