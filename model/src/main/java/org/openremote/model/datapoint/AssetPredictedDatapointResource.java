...
@Tag(
    ...
    description = "Read and replace predicted future values for asset attributes")
...
public interface AssetPredictedDatapointResource {
  ...
  ValueDatapoint<?>[] getPredictedDatapoints(
      ...
      @RequestBody(
              description =
                  "Optional time range, ordering, limit, and aggregation strategy for predicted values.")
  ...
  void writePredictedDatapoints(
      ...
      @RequestBody(
              required = true,
              description = "Timestamped predicted values to store for the attribute.")
