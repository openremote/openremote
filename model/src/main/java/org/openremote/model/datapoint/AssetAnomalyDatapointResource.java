...
public interface AssetAnomalyDatapointResource {
    /**
     * Retrieve the anomaly datapoints of an asset attribute. Regular users can only access assets in their
    ...
    AttributeAnomaly[] getAnomalyDatapoints(@BeanParam RequestParams requestParams,
