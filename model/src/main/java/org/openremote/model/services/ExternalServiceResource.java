...
public interface ExternalServiceResource {
  ...
  ExternalService registerService(
      @BeanParam RequestParams requestParams, @NotNull @Valid ExternalService service);
  ...
  ExternalService[] getServices(
      @BeanParam RequestParams requestParams, @QueryParam("realm") @NotNull String realm);
  ...
  @Operation(
      ...
      summary = "Retrieve a specific external service by its serviceId and instanceId",
      responses = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      summary = "Update the active registration lease for the specified external service",
      responses = {
