 ...
 *
 * <p>This is a Hibernate identifier generator as well: Assigns a random UUID if the persisted
 * entity instance is of type {@link IdentifiableEntity} and if its {@link
 * IdentifiableEntity#getId()} method returns <code>null</code>.
 */
