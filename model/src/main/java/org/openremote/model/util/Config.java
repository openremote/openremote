...
/**
 * A simple utility for overlaying runtime configuration on top of {@link System#getenv()} env
 * config. The application is responsible for injecting the additional config at the earliest
 * opportunity before it is consumed by other code.
 */
public class Config {
