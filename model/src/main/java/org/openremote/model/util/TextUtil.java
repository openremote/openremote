...
public class TextUtil {
  ...
  public static final String REGEXP_PATTERN_DOUBLE_NEGATIVE =
      "^(-([0-9]+(\\.[0-9]+)|[1-9]\\d*)|0)$";
  public static final String REGEXP_PATTERN_DOUBLE_NON_ZERO =
      "^-?(?!0*(\\.0+)?$)([0-9]+\\.[0-9]+|[1-9]\\d*)$";
  public static final String REGEXP_PATTERN_DOUBLE_POSITIVE_NON_ZERO =
      "^(?!0*(\\.0+)?$)([0-9]+\\.[0-9]+|[1-9]\\d*)$";
  public static final String REGEXP_PATTERN_DOUBLE_NEGATIVE_NON_ZERO =
      "^-(?!0*(\\.0+)?$)([0-9]+\\.[0-9]+|[1-9]\\d*)$";
  ...
  public static final Pattern REGEXP_INTEGER_POSITIVE =
      Pattern.compile(REGEXP_PATTERN_INTEGER_POSITIVE);
  public static final Predicate<String> INTEGER_POSITIVE_VALIDATOR =
      name -> !isNullOrEmpty(name) && REGEXP_INTEGER_POSITIVE.matcher(name).matches();

  // TODO Unused, doesn't work for "0 30 8 ? * FRI *
  public static final String REGEXP_PATTERN_CRON_EXPRESSION =
      "^\\\\s*($|#|\\\\w+\\\\s*=|(\\\\?|\\\\*|(?:[0-5]?\\\\d)(?:(?:-|\\/|\\\\,)(?:[0-5]?\\\\d))?(?:,(?:[0-5]?\\\\d)(?:(?:-|\\/|\\\\,)(?:[0-5]?\\\\d))?)*)\\\\s+(\\\\?|\\\\*|(?:[0-5]?\\\\d)(?:(?:-|\\/|\\\\,)(?:[0-5]?\\\\d))?(?:,(?:[0-5]?\\\\d)(?:(?:-|\\/|\\\\,)(?:[0-5]?\\\\d))?)*)\\\\s+(\\\\?|\\\\*|(?:[01]?\\\\d|2[0-3])(?:(?:-|\\/|\\\\,)(?:[01]?\\\\d|2[0-3]))?(?:,(?:[01]?\\\\d|2[0-3])(?:(?:-|\\/|\\\\,)(?:[01]?\\\\d|2[0-3]))?)*)\\\\s+(\\\\?|\\\\*|(?:0?[1-9]|[12]\\\\d|3[01])(?:(?:-|\\/|\\\\,)(?:0?[1-9]|[12]\\\\d|3[01]))?(?:,(?:0?[1-9]|[12]\\\\d|3[01])(?:(?:-|\\/|\\\\,)(?:0?[1-9]|[12]\\\\d|3[01]))?)*)\\\\s+(\\\\?|\\\\*|(?:[1-9]|1[012])(?:(?:-|\\/|\\\\,)(?:[1-9]|1[012]))?(?:L|W)?(?:,(?:[1-9]|1[012])(?:(?:-|\\/|\\\\,)(?:[1-9]|1[012]))?(?:L|W)?)*|\\\\?|\\\\*|(?:JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC)(?:(?:-)(?:JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC))?(?:,(?:JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC)(?:(?:-)(?:JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC))?)*)\\\\s+(\\\\?|\\\\*|(?:[0-6])(?:(?:-|\\/|\\\\,|#)(?:[0-6]))?(?:L)?(?:,(?:[0-6])(?:(?:-|\\/|\\\\,|#)(?:[0-6]))?(?:L)?)*|\\\\?|\\\\*|(?:MON|TUE|WED|THU|FRI|SAT|SUN)(?:(?:-)(?:MON|TUE|WED|THU|FRI|SAT|SUN))?(?:,(?:MON|TUE|WED|THU|FRI|SAT|SUN)(?:(?:-)(?:MON|TUE|WED|THU|FRI|SAT|SUN))?)*)(|\\\\s)+(\\\\?|\\\\*|(?:|\\\\d{4})(?:(?:-|\\/|\\\\,)(?:|\\\\d{4}))?(?:,(?:|\\\\d{4})(?:(?:-|\\/|\\\\,)(?:|\\\\d{4}))?)*))$";

  /**
   * Converts a String which represents a pollingInterval into an int which can be used as delay for
   * Thread.sleep();
   *
   * <p>
   *
   * <p>Following conversion will happen:
   *
   * <p>
   *
   * <p>null || "" = -1 <br>
  ...
  public static String[] fromCommaSeparated(String commaWords) {
    if (commaWords == null || commaWords.length() == 0) return new String[0];
    return commaWords.split(",");
  }

  /**
   * Get an enum value from a string without throwing exception. Enum should be in uppercase to use
   * this method.
   */
  ...
  /**
   * Transforms <code>EXFooBar123</code> into <code>ex-foo-bar-123</code> and <code>attributeX
   * </code> into <code>attribute-x</code> without regex.
   */
