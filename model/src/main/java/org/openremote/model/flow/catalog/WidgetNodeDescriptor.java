...
public abstract class WidgetNodeDescriptor extends ConsoleNodeDescriptor {
    ...
    public static final ObjectNode WIDGET_INITIAL_PROPERTIES = ValueUtil.JSON.createObjectNode().put("positionX", 25)
            .put("positionY", 25).put("positionZ", 0).put("opacity", 1.0);

    public static final String[] WIDGET_PERSISTENT_PROPERTY_PATHS = new String[] { PROPERTY_COMPONENT, "positionX",
            "positionY", "positionZ", "opacity" };
