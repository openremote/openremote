...
public class PushNotificationAction {
    ...
    @JsonCreator
    public PushNotificationAction(@JsonProperty("url") String url, @JsonProperty("data") Object data,
            @JsonProperty("silent") boolean silent, @JsonProperty("openInBrowser") boolean openInBrowser,
