...
public interface NotificationResource {
  ...
  /**
   * Gets all sent notifications that have been sent to the specified targets; optionally limiting
   * the scope of the request by {@link AbstractNotificationMessage} type and/or sent datetime. If
   * type(s) or timestamp are not set then it is assumed no type or time constraint is required. Can
   * also provide a list of notification IDs to get specific notifications.
   *
   * <p>Only the superuser can call this operation.
   */
  @GET
  ...
  // RT: Was using lists here but they don't work with JSAPI because GWT doesn't use JSArrays for
  // lists - another
  ...
  void removeNotification(
      @BeanParam RequestParams requestParams, @PathParam("notificationId") Long notificationId);
