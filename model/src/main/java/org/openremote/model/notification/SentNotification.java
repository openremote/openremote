...
public class SentNotification {
    ...
    public String toString() {
        return getClass().getSimpleName() + "{" + "id=" + id + ", name='" + name + '\'' + ", type='" + type + '\''
                + ", target=" + target + ", targetId='" + targetId + '\'' + ", source=" + source + ", sourceId='"
                + sourceId + '\'' + ", message=" + message + ", sentOn=" + sentOn + ", deliveredOn=" + deliveredOn
                + ", acknowledgedOn=" + acknowledgedOn + ", acknowledgement='" + acknowledgement + '\'' + '}';
    }
}
