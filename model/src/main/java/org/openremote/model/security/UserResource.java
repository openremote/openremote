...
public interface UserResource {
    ...
    Role[] getClientRoles(@BeanParam RequestParams requestParams, @PathParam("realm") String realm,
    ...
    void updateClientRoles(@BeanParam RequestParams requestParams, @PathParam("realm") String realm, Role[] roles,
            @PathParam("clientId") String clientId);
    ...
    User get(@BeanParam RequestParams requestParams, @PathParam("realm") String realm,
    ...
    void resetPassword(@BeanParam RequestParams requestParams, @PathParam("realm") String realm,
            @PathParam("userId") String userId, Credential credential);
    ...
    String resetSecret(@BeanParam RequestParams requestParams, @PathParam("realm") String realm,
            @PathParam("userId") String userId);
    ...
    Role[] getUserRoles(@BeanParam RequestParams requestParams, @PathParam("realm") String realm,
            @PathParam("userId") String userId);
    ...
    Role[] getUserClientRoles(@BeanParam RequestParams requestParams, @PathParam("realm") String realm,
            @PathParam("userId") String userId, @PathParam("clientId") String clientId);
    ...
    Role[] getUserRealmRoles(@BeanParam RequestParams requestParams, @PathParam("realm") String realm,
            @PathParam("userId") String userId);
    ...
    void updateUserRoles(@BeanParam RequestParams requestParams, @PathParam("realm") String realm,
            @PathParam("userId") String userId, Role[] roles);
    ...
    void updateUserClientRoles(@BeanParam RequestParams requestParams, @PathParam("realm") String realm,
            @PathParam("userId") String userId, Role[] roles, @PathParam("clientId") String clientId);
    ...
    void updateUserRealmRoles(@BeanParam RequestParams requestParams, @PathParam("realm") String realm,
            @PathParam("userId") String userId, Role[] roles);
    ...
    UserSession[] getUserSessions(@BeanParam RequestParams requestParams, @PathParam("realm") String realm,
            @PathParam("userId") String userId);
    ...
    void disconnectUserSession(@BeanParam RequestParams requestParams, @PathParam("realm") String realm,
