...
@Tag(
    name = "Rule",
    description = "Inspect rule engines and query or manage global, realm, and asset rulesets")
@Path("rules")
public interface RulesResource {

  /**
   * Retrieve information about the global rules engine (if engine doesn't exist then will return
   * null).
   */
  @GET
  ...
  /**
   * Retrieve information about the specified realm rules engine (if engine doesn't exist then will
   * return null).
   */
  @GET
  @Produces(APPLICATION_JSON)
  ...
  @ApiResponse(
      responseCode = "204",
      description = "The requested realm rules engine is not running")
  RulesEngineInfo getRealmEngineInfo(
      @BeanParam RequestParams requestParams,
      @Parameter(description = REALM, example = EXAMPLE_REALM) @PathParam("realm") String realm);

  /**
   * Retrieve information about the specified asset rules engine (if engine doesn't exist then will
   * return null).
   */
  @GET
  @Produces(APPLICATION_JSON)
  ...
  RulesEngineInfo getAssetEngineInfo(
      @BeanParam RequestParams requestParams,
      @Parameter(description = ASSET_ID, example = EXAMPLE_ASSET_ID) @PathParam("assetId")
          String assetId);

  /**
   * Retrieve global rules. Only the superuser can perform this operation, a 403 status is returned
   * if a regular user tries to access global rulesets.
   */
  @GET
  @Produces(APPLICATION_JSON)
  @RolesAllowed({Constants.READ_RULES_ROLE})
  @Operation(
      ...
      summary = "Retrieve global rulesets",
      description =
  ...
  GlobalRuleset[] getGlobalRulesets(
      ...
      @Parameter(
              description =
                  "Rule languages to include; repeat the query parameter for multiple values.",
              style = ParameterStyle.FORM,
              explode = Explode.TRUE)
          @QueryParam("language")
          List<Ruleset.Lang> languages,
      @Parameter(
              description =
                  "Include rule source, meta, and other large fields instead of summary records.",
              example = "true")
          @QueryParam("fullyPopulate")
          boolean fullyPopulate);

  /**
   * Retrieve rules of a realm. The superuser can retrieve rules of all realms, a 403 status is
   * returned if a regular user tries to access rulesets outside of its authenticated realm. An
   * empty result will be returned if the realm can not be found.
   */
  @GET
  ...
  @Operation(
      ...
      summary = "Retrieve rulesets for a realm",
      description =
  ...
  /**
   * Retrieve rules of an asset. The superuser can retrieve rules of all realms and assets, a 403
   * status is returned if a regular user tries to access ruleset outside of its authenticated
   * realm, or if the user is restricted and the asset is not one of its linked assets. An empty
   * result will be returned if the asset can not be found.
   */
  @GET
  ...
  @Operation(
      ...
      summary = "Retrieve rulesets for an asset",
      description =
  ...
  @OpenApiResponses.Authenticated
  @OpenApiResponses.BadRequest
  long createGlobalRuleset(
      @BeanParam RequestParams requestParams,
      @Valid @RequestBody(
              required = true,
              description =
                  "Global ruleset name, language, source, enabled state, and optional metadata.")
  ...
  GlobalRuleset getGlobalRuleset(
      @BeanParam RequestParams requestParams,
      @Parameter(description = "Numeric ruleset identifier.", example = "27") @PathParam("id")
          Long id);

  /**
   * Update a global ruleset. Only the superuser can perform this operation, a 403 status is
   * returned if a regular user tries to access global ruleset.
   */
  @PUT
  @Path("{id}")
  ...
  void updateGlobalRuleset(
      @BeanParam RequestParams requestParams,
      @Parameter(
              description = "Numeric ruleset identifier; must match the body id.",
              example = "27")
          @PathParam("id")
          Long id,
      @Valid @RequestBody(
              required = true,
              description = "Complete replacement global ruleset; its id must match the path.")
          GlobalRuleset ruleset);
  ...
  /**
   * Create a realm ruleset. The superuser can create rules in all realms, a 403 status is returned
   * if a regular user tries to access ruleset outside of its authenticated realm, or if the user is
   * restricted.
   */
  @POST
  @Path("realm")
  ...
  @OpenApiResponses.Authenticated
  @OpenApiResponses.BadRequest
  long createRealmRuleset(
      @BeanParam RequestParams requestParams,
      @Valid @RequestBody(
              required = true,
              description =
                  "Realm ruleset including its target realm, name, language, source, and enabled state.")
          RealmRuleset ruleset);

  /**
   * Retrieve a realm ruleset. The superuser can retrieve rules of all realms, a 403 status is
   * returned if a regular user tries to access ruleset outside of its authenticated realm, or if
  ...
  @OpenApiResponses.Authenticated
  @OpenApiResponses.NotFound
  RealmRuleset getRealmRuleset(
      @BeanParam RequestParams requestParams,
      @Parameter(description = "Numeric ruleset identifier.", example = "27") @PathParam("id")
          Long id);

  /**
   * Update a realm ruleset. The superuser can update rules of all realms, a 403 status is returned
   * if a regular user tries to access rulesets outside of its authenticated realm, or if the user
   * is restricted.
   */
  @PUT
  @Path("realm/{id}")
  ...
  void updateRealmRuleset(
      ...
      @Valid @RequestBody(
              required = true,
              description =
                  "Complete replacement realm ruleset; its id and realm must match the existing ruleset.")
          RealmRuleset ruleset);

  /**
   * Delete a realm ruleset. The superuser can delete rules of all realms, a 403 status is returned
   * if a regular user tries to access rulesets outside of its authenticated realm, or if the user
   * is restricted.
   */
  @DELETE
  ...
  /**
   * Create an asset ruleset. The superuser can create rules for all assets, a 403 status is
   * returned if a regular user tries to access ruleset outside of its authenticated realm, or if
   * the user is restricted and does not have access to the asset.
   */
  @POST
  @Path("asset")
  @Consumes(APPLICATION_JSON)
  ...
  @OpenApiResponses.BadRequest
  @OpenApiResponses.NotFound
  long createAssetRuleset(
      @BeanParam RequestParams requestParams,
      @Valid @RequestBody(
              required = true,
              description =
                  "Asset ruleset including its target assetId, name, language, source, and enabled state.",
              content =
                  @Content(
                      mediaType = APPLICATION_JSON,
                      schema = @Schema(implementation = AssetRuleset.class),
                      examples =
                          @ExampleObject(
                              name = "Asset alert ruleset",
                              summary = "Create an enabled JSON ruleset for one asset",
                              value = ASSET_RULESET_CREATE)))
          AssetRuleset ruleset);

  /**
   * Retrieve an asset ruleset. The superuser can retrieve rules of all assets, a 403 status is
   * returned if a regular user tries to access ruleset outside of its authenticated realm, or if
   * the user is restricted and does not have access to the asset.
   */
  @GET
  ...
  @OpenApiResponses.Authenticated
  @OpenApiResponses.NotFound
  AssetRuleset getAssetRuleset(
      @BeanParam RequestParams requestParams,
      @Parameter(description = "Numeric ruleset identifier.", example = "27") @PathParam("id")
          Long id);

  /**
   * Update an asset ruleset. The superuser can update rules of all assets, a 403 status is returned
   * if a regular user tries to access ruleset outside of its authenticated realm, or if the user is
   * restricted and does not have access to the asset.
   */
  @PUT
  @Path("asset/{id}")
  @Consumes(APPLICATION_JSON)
  ...
  void updateAssetRuleset(
      ...
      @Valid @RequestBody(
              required = true,
              description =
                  "Complete replacement asset ruleset; its id and assetId must match the existing ruleset.")
          AssetRuleset ruleset);

  /**
   * Delete an asset ruleset. The superuser can delete rules of all assets, a 403 status is returned
   * if a regular user tries to access ruleset outside of its authenticated realm, or if the user is
   * restricted and does not have access to the asset.
   */
  @DELETE
  ...
  @OpenApiResponses.Authenticated
  @OpenApiResponses.NotFound
  void deleteAssetRuleset(
      @BeanParam RequestParams requestParams,
      @Parameter(description = "Numeric ruleset identifier.", example = "27") @PathParam("id")
          Long id);

  /**
   * Get the geofences for the specified asset; if this method is accessed anonymously (public read)
   * then the asset must have public read enabled. Otherwise the asset must be linked to the logged
   * in user. If neither of these conditions are met then a 403 is returned.
   */
  @GET
  ...
  @Operation(
      ...
      summary = "Retrieve geofences for an asset",
      description =
  ...
  @OpenApiResponses.Forbidden
  @OpenApiResponses.NotFound
  GeofenceDefinition[] getAssetGeofences(
      @BeanParam RequestParams requestParams,
      @Parameter(description = ASSET_ID, example = EXAMPLE_ASSET_ID) @PathParam("assetId")
          String assetId);
}
