...
public class Node {
  // Generation of ID is the responsibility of the front end and is unique for every node in a
  // structure, not for every node in the system
  private String id;
  ...
  public Node(
    ...
    if (internals.length != 0)
      throw new IllegalArgumentException(
          "A node cannot have internals when a display character is specified");
