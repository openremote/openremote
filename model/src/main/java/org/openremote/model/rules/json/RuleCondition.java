 ...
 * <li>{@link #cron} - CRON expression (e.g. "*&#47;5 * * * *") at which time the condition becomes true - 1min precision</li>
 * <li>{@link #sun} - CRON expression (e.g. "*&#47;5 * * * *") at which time the condition becomes true - 1min precision</li>
