...
/**
 * Indicates that discovery has started/stopped for the given {@link #getAgentDescriptor}. If
 * discovery has started then {@link #isStopped} will be false, otherwise true.
 */
public class ProtocolDiscoveryStartStopResponseEvent extends SharedEvent {
  ...
  @JsonCreator
  public ProtocolDiscoveryStartStopResponseEvent(
