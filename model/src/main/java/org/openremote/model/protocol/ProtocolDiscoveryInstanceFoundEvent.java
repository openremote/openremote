...
public class ProtocolDiscoveryInstanceFoundEvent extends SharedEvent {
    ...
    @JsonCreator
    public ProtocolDiscoveryInstanceFoundEvent(@JsonProperty("agentDescriptor") String agentDescriptor,
            @JsonProperty("instanceName") String instanceName, @JsonProperty("attributes") Attribute<?>[] attributes) {
