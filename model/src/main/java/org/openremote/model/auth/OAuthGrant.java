...
@JsonSubTypes({ @JsonSubTypes.Type(name = OAuthPasswordGrant.PASSWORD_GRANT_TYPE, value = OAuthPasswordGrant.class),
...
public abstract class OAuthGrant implements Serializable {
    ...
    protected OAuthGrant(String tokenEndpointUri, String grantType, String clientId, String clientSecret,
            String scope) {
    ...
    public boolean equals(Object o) {
        ...
        return basicAuthHeader == grant.basicAuthHeader && Objects.equals(tokenEndpointUri, grant.tokenEndpointUri)
                && Objects.equals(grantType, grant.grantType) && Objects.equals(clientId, grant.clientId)
                && Objects.equals(clientSecret, grant.clientSecret) && Objects.equals(scope, grant.scope);
    }
    ...
    public String toString() {
        return OAuthGrant.class.getSimpleName() + "{" + "tokenEndpointUri='" + tokenEndpointUri + '\''
