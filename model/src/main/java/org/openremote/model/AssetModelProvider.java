...
/**
 * Provides model descriptors that are processed by {@link Values}; implementations can be discovered using the
 * standard {@link ServiceLoader} mechanism or can be manually registered by adding an instance to the {@link
 * Values#getModelProviders}.
 * <p>
...
public interface AssetModelProvider {
     ...
     * duplicate conflicts will generate an {@link IllegalStateException} during {@link Values} initialisation.
     */
     ...
     * conflicts will generate an {@link IllegalStateException} during {@link Values} initialisation.
     * <p>
     * If {@link #useAutoScan} is true and this is also defined then the results will be combined with those returned by
     * scanning.
     */
     ...
     * will generate an {@link IllegalStateException} during {@link Values} initialisation. Shouldn't contain
