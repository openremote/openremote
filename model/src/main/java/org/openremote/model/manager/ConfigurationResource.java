...
public interface ConfigurationResource {
  ...
  ManagerAppConfig update(
      @BeanParam RequestParams requestParams, ManagerAppConfig managerConfiguration);
  ...
  String fileUpload(
      @BeanParam RequestParams requestParams, @QueryParam("path") String path, FileInfo fileInfo);
