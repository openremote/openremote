...
@JsonSubTypes({ @JsonSubTypes.Type(value = RegexValueFilter.class),
        @JsonSubTypes.Type(value = SubStringValueFilter.class), @JsonSubTypes.Type(value = JsonPathFilter.class) })
