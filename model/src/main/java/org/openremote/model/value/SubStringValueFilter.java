...
@JsonClassDescription(
    "Returns the substring beginning at the specified index (inclusive) and ending at the optional endIndex (exclusive); if endIndex is not supplied then"
...
public class SubStringValueFilter extends ValueFilter {
  ...
  @JsonCreator
  public SubStringValueFilter(
      @JsonProperty("beginIndex") int beginIndex, @JsonProperty("endIndex") Integer endIndex) {
