...
public class ForecastConfigurationWeightedExponentialAverage extends ForecastConfiguration {
    ...
    public boolean isValid() {
        return pastCount != null && pastCount > 0 && forecastCount != null && forecastCount > 0 && pastPeriod != null
                && pastPeriod.toMillis() > 0 && forecastPeriod != null && forecastPeriod.toMillis() > 0;
    }
