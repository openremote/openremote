...
public class ForecastConfigurationWeightedExponentialAverage extends ForecastConfiguration {
  ...
  protected static final Pattern iso8601Pattern =
      Pattern.compile(Constants.ISO8601_DURATION_REGEXP);
  ...
  @NotNull @JsonSerialize(using = ToStringSerializer.class)
  @JsonDeserialize(converter = PeriodAndDurationConverter.class)
  protected ForecastConfigurationWeightedExponentialAverage.ExtendedPeriodAndDuration
      forecastPeriod;
  ...
  public ForecastConfigurationWeightedExponentialAverage(
      @JsonProperty("pastPeriod") ExtendedPeriodAndDuration pastPeriod,
      @JsonProperty("pastCount") Integer pastCount,
      @JsonProperty("forecastPeriod") ExtendedPeriodAndDuration forecastPeriod,
  ...
  public static class PeriodAndDurationConverter
      extends StdConverter<JsonNode, ExtendedPeriodAndDuration> {
    @Override
