...
public final class ValueType {
    ...
    public static final ValueDescriptor<MultivaluedStringMap> MULTIVALUED_TEXT_MAP = new ValueDescriptor<>(
            "multivaluedTextMap", MultivaluedStringMap.class);

    public static final ValueDescriptor<Integer> POSITIVE_INTEGER = new ValueDescriptor<>("positiveInteger",
            Integer.class, new ValueConstraint.Min(0));

    public static final ValueDescriptor<Integer> NEGATIVE_INTEGER = new ValueDescriptor<>("negativeInteger",
            Integer.class, new ValueConstraint.Max(0));
    ...
    public static final ValueDescriptor<Integer> INT_BYTE = new ValueDescriptor<>("integerByte", Integer.class,
            new ValueConstraint.Min(0), new ValueConstraint.Max(255));
    ...
    public static final ValueDescriptor<String> TIMESTAMP_ISO8601 = new ValueDescriptor<>("timestampISO8601",
            String.class, new ValueConstraint.Pattern(Constants.ISO8601_DATETIME_REGEXP));

    public static final ValueDescriptor<Date> DATE_AND_TIME = new ValueDescriptor<>("dateAndTime", Date.class);

    public static final ValueDescriptor<Duration> DURATION_TIME_ISO8601 = new ValueDescriptor<>("timeDurationISO8601",
            Duration.class, new ValueConstraint.Pattern(Constants.ISO8601_DURATION_REGEXP));

    public static final ValueDescriptor<Period> DURATION_PERIOD_ISO8601 = new ValueDescriptor<>("periodDurationISO8601",
            Period.class, new ValueConstraint.Pattern(Constants.ISO8601_DURATION_REGEXP));

    public static final ValueDescriptor<PeriodAndDuration> PERIOD_ISO8601 = new ValueDescriptor<>(
            "timeAndPeriodDurationISO8601", PeriodAndDuration.class,
    ...
    public static final ValueDescriptor<Integer> DIRECTION = new ValueDescriptor<>("direction", Integer.class,
            new ValueConstraint.Min(0), new ValueConstraint.Max(359));

    public static final ValueDescriptor<Integer> PORT = new ValueDescriptor<>("TCP_IPPortNumber", Integer.class,
            new ValueConstraint.Min(1), new ValueConstraint.Max(65536));

    public static final ValueDescriptor<String> HOSTNAME_OR_IP_ADDRESS = new ValueDescriptor<>("hostOrIPAddress",
            String.class, new ValueConstraint.Pattern(Constants.HOSTNAME_OR_IP_REGEXP));
    ...
    public static final ValueDescriptor<AttributeLink> ATTRIBUTE_LINK = new ValueDescriptor<>("attributeLink",
            AttributeLink.class).forMetaUseOnly();

    public static final ValueDescriptor<AttributeRef> ATTRIBUTE_REF = new ValueDescriptor<>("attributeReference",
            AttributeRef.class).forMetaUseOnly();

    public static final ValueDescriptor<AttributeState> ATTRIBUTE_STATE = new ValueDescriptor<>("attributeState",
            AttributeState.class).forMetaUseOnly();

    public static final ValueDescriptor<GeoJSONPoint> GEO_JSON_POINT = new ValueDescriptor<>("GEO_JSONPoint",
            GeoJSONPoint.class);

    public static final ValueDescriptor<CalendarEvent> CALENDAR_EVENT = new ValueDescriptor<>("calendarEvent",
            CalendarEvent.class);

    public static final ValueDescriptor<AttributeExecuteStatus> EXECUTION_STATUS = new ValueDescriptor<>(
            "executionStatus", AttributeExecuteStatus.class);

    public static final ValueDescriptor<ConnectionStatus> CONNECTION_STATUS = new ValueDescriptor<>("connectionStatus",
            ConnectionStatus.class);

    public static final ValueDescriptor<ConsoleProviders> CONSOLE_PROVIDERS = new ValueDescriptor<>("consoleProviders",
            ConsoleProviders.class);
    ...
    public static final ValueDescriptor<UsernamePassword> USERNAME_AND_PASSWORD = new ValueDescriptor<>(
            "usernameAndPassword", UsernamePassword.class);

    public static final ValueDescriptor<ValueFormat> VALUE_FORMAT = new ValueDescriptor<>("valueFormat",
            ValueFormat.class).forMetaUseOnly();

    public static final ValueDescriptor<ValueConstraint> VALUE_CONSTRAINT = new ValueDescriptor<>("valueConstraint",
            ValueConstraint.class).forMetaUseOnly();

    public static final ValueDescriptor<AgentLink> VALUE_AGENT_LINK = new ValueDescriptor<>("agentLink",
            AgentLink.class).forMetaUseOnly();

    public static final ValueDescriptor<CronExpressionParser> CRON_EXPRESSION = new ValueDescriptor<>("CRONExpression",
            CronExpressionParser.class);
    ...
    public static final ValueDescriptor<ForecastConfiguration> FORECAST_CONFIGURATION = new ValueDescriptor<>(
            "forecastConfiguration", ForecastConfiguration.class).forMetaUseOnly();

    public static final ValueDescriptor<ValueDescriptor> VALUE_DESCRIPTOR_VALUE_DESCRIPTOR = new ValueDescriptor<>(
            "valueDescriptor", ValueDescriptor.class).forMetaUseOnly();
