...
public class Webhook {
    ...
    @JsonCreator
    public Webhook(String name, String url, Map<String, List<String>> headers, HTTPMethod httpMethod,
            UsernamePassword usernamePassword, OAuthGrant oAuthGrant, String payload) {
        this.name = name;
        this.url = url;
