...
// TODO: Remove sshHostname and sshPort once enough time has passed that the old clients have been
// updated
public class GatewayTunnelStartRequestEvent extends SharedEvent implements RespondableEvent {

  @Deprecated protected String sshHostname;
  @Deprecated protected int sshPort;
