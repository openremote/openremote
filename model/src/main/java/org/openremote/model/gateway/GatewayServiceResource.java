...
public interface GatewayServiceResource {
    ...
    GatewayTunnelInfo[] getGatewayActiveTunnelInfos(@BeanParam RequestParams requestParams,
            @PathParam("realm") String realm, @PathParam("id") String gatewayId);
    ...
    GatewayTunnelInfo getActiveTunnelInfo(@BeanParam RequestParams requestParams, @PathParam("realm") String realm,
            @PathParam("id") String gatewayId, @PathParam("target") String target,
