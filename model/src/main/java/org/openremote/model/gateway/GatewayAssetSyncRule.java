 ...
 * asset type before it is sent to the central instance as well as configuring the accessPublicRead
 * flag of the asset.
 */
public class GatewayAssetSyncRule {
  ...
  /**
   * Override the accessPublicRead flag of the asset; if not set then the value is taken from the
   * asset itself.
   */
  ...
  public int hashCode() {
    return Objects.hash(
        accessPublicRead, excludeAttributes, excludeAttributeMeta, addAttributeMeta);
  }
}
