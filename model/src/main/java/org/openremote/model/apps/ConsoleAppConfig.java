...
public class ConsoleAppConfig {
    ...
    public ConsoleAppConfig(String realm, String initialUrl, String url, Boolean menuEnabled, MenuPosition menuPosition,
            String primaryColor, String secondaryColor, AppLink[] links) {
        this.realm = realm;
