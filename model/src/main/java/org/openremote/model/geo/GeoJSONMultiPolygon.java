 ...
 *
 * <p>A MultiPolygon is an array of Polygon coordinate arrays. Each polygon can have holes.
 */
@JsonTypeName(TYPE)
public class GeoJSONMultiPolygon extends GeoJSONGeometry {

  public static class CoordinateListConverter
      extends StdConverter<List<List<Coordinate[]>>, double[][][][]> {
  ...
  public static class CoordinateListConverterJackson2
      extends com.fasterxml.jackson.databind.util.StdConverter<
          List<List<Coordinate[]>>, double[][][][]> {
  ...
  @com.fasterxml.jackson.databind.annotation.JsonSerialize(
      converter = CoordinateListConverterJackson2.class)
    ...
    for (double[][][] polygon : coordinates) {
      if (polygon.length == 0) {
        throw new IllegalArgumentException(
            "Each polygon must have at least one ring (exterior ring)");
      }
