 ...
 *
 * <ul>
 *   <li>{@link #value} - Does array contain this value
 *   <li>{@link #index} - If specified will check that the value at this index equals the specified
 *       {@link #value}
 *   <li>{@link #lengthEquals} - Is length of array equal to the specified value
 *   <li>{@link #lengthGreaterThan} - Is length of array greater than the specified value
 *   <li>{@link #lengthLessThan} - Is length of array less than the specified value
 * </ul>
 *
 * There is an implicit 'and' between each specified condition; the negation is applied once all the
