...
/**
 * Predicate for GEO JSON point values; will return true if the point is within the specified radius
 * of the specified latitude and longitude unless negated.
 */
