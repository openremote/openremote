...
public class DashboardQuery implements Serializable {
  ...
  /**
   * A top-level object of {@link DashboardQuery}, that is meant for filtering its output. For
   * example used to only return metadata of dashboards, instead of ALL data.
   */
  ...
  public static class DashboardConditions {
    ...
    public DashboardConditions() {
      this.viewAccess =
          new DashboardAccess[] {
            DashboardAccess.PUBLIC, DashboardAccess.SHARED, DashboardAccess.PRIVATE
          };
      this.editAccess =
          new DashboardAccess[] {
            DashboardAccess.PUBLIC, DashboardAccess.SHARED, DashboardAccess.PRIVATE
    ...
    public DashboardConditions(
        DashboardAccess[] viewAccess, DashboardAccess[] editAccess, Integer minWidgets) {
  ...
  public static class AssetConditions {
    ...
    public AssetConditions(
        AssetAccess[] access, ConditionMinAmount minAmount, ParentPredicate[] parents) {
      this.access = access;
