...
public class VentilationAsset extends Asset<VentilationAsset> {
    ...
    public static final AttributeDescriptor<Integer> FAN_SPEED = new AttributeDescriptor<>("fanSpeed",
    ...
    public static final AttributeDescriptor<Double> FLOW = new AttributeDescriptor<>("flow", ValueType.NUMBER,
            new MetaItem<>(MetaItemType.READ_ONLY)).withUnits(UNITS_METRE, UNITS_CUBED, UNITS_PER, UNITS_HOUR);

    public static final AssetDescriptor<VentilationAsset> DESCRIPTOR = new AssetDescriptor<>("fan", "0b99c3",
            VentilationAsset.class);
