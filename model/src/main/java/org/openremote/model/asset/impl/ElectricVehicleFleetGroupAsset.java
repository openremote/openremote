...
public class ElectricVehicleFleetGroupAsset extends GroupAsset {
    ...
    public static final AttributeDescriptor<String> FLEET_CATEGORY = new AttributeDescriptor<>("fleetCategory",
            ValueType.TEXT);
    public static final AttributeDescriptor<Integer> AVAILABLE_CHARGING_SPACES = new AttributeDescriptor<>(
            "availableChargingSpaces", ValueType.POSITIVE_INTEGER);
    public static final AttributeDescriptor<Integer> AVAILABLE_DISCHARGING_SPACES = new AttributeDescriptor<>(
            "availableDischargingSpaces", ValueType.POSITIVE_INTEGER);
    public static final AttributeDescriptor<Integer> POWER_IMPORT_MAX = new AttributeDescriptor<>("powerImportMax",
            ValueType.POSITIVE_INTEGER);
    public static final AttributeDescriptor<Integer> POWER_EXPORT_MAX = new AttributeDescriptor<>("powerExportMax",
            ValueType.POSITIVE_INTEGER);

    public static final AttributeDescriptor<Integer> MILEAGE_MINIMUM = new AttributeDescriptor<>("mileageMinimum",
            ValueType.POSITIVE_INTEGER).withUnits(UNITS_KILO, UNITS_METRE);

    public static final AssetDescriptor<ElectricVehicleFleetGroupAsset> DESCRIPTOR = new AssetDescriptor<>(
            "car-multiple", "49B0D8", ElectricVehicleFleetGroupAsset.class);
