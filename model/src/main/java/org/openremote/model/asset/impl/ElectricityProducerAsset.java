...
public class ElectricityProducerAsset extends ElectricityAsset<ElectricityProducerAsset> {
    ...
    public static final AttributeDescriptor<Double> POWER_FORECAST = new AttributeDescriptor<>("powerForecast",
            ValueType.NUMBER, new MetaItem<>(MetaItemType.READ_ONLY)).withUnits(UNITS_KILO, UNITS_WATT);

    public static final AssetDescriptor<ElectricityProducerAsset> DESCRIPTOR = new AssetDescriptor<>("flash", "EABB4D",
            ElectricityProducerAsset.class);
