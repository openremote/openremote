...
/**
 * An asset for grouping other assets together; The {@link #CHILD_ASSET_TYPE} {@link Attribute} must
 * be specified and all children must be of the specified type or a subtype of the specified type.
 */
@Entity
public class GroupAsset extends Asset<GroupAsset> {

  public static final AttributeDescriptor<String> CHILD_ASSET_TYPE =
      new AttributeDescriptor<>(
          "childAssetType", ValueType.ASSET_TYPE, new MetaItem<>(MetaItemType.READ_ONLY));
  public static final AssetDescriptor<GroupAsset> DESCRIPTOR =
      new AssetDescriptor<>("folder", "B3B3B3", GroupAsset.class);
