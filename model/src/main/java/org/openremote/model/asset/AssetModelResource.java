...
public interface AssetModelResource {
    ...
    AssetTypeInfo[] getAssetInfos(@BeanParam RequestParams requestParams, @QueryParam("parentId") String parentId,
    ...
    AssetTypeInfo getAssetInfo(@BeanParam RequestParams requestParams, @QueryParam("parentId") String parentId,
    ...
    AssetDescriptor<?>[] getAssetDescriptors(@BeanParam RequestParams requestParams,
            @QueryParam("parentId") String parentId, @QueryParam("parentType") String parentType);
