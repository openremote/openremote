...
public class CustomAsset extends Asset<CustomAsset> {
    ...
    public static final AssetDescriptor<CustomAsset> DESCRIPTOR = new AssetDescriptor<>("lightbulb", "e6688a", CustomAsset.class);
    ...
    public CustomAsset setOnOff(Boolean value) {
    ...
    public CustomAsset setBrightness(Integer value) {
    ...
    public CustomAsset setColourRGB(ColourRGB value) {
    ...
    public CustomAsset setTemperature(Integer value) {
