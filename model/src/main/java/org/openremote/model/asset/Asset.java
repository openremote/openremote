...
public abstract class Asset<T extends Asset<?>> implements IdentifiableEntity<T>, AssetInfo {
  ...
  @Pattern(regexp = Constants.ASSET_ID_REGEXP, message = "{Asset.id.Pattern}") @GeneratedValue(generator = PERSISTENCE_UNIQUE_ID_GENERATOR)
  protected String id;
   ...
   *
   * <p>The identifiers of all parents representing the path in the tree. The first element is the
   * identifier of this instance, the last is the root asset without a parent.
   */
