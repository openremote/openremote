...
public abstract class AgentLink<T extends AgentLink<?>> implements Serializable {
  ...
  @JsonSchemaInject(
      ...
      jsonSupplierViaLookup =
          JSONSchemaUtil.SCHEMA_SUPPLIER_NAME_PATTERN_PROPERTIES_ANY_KEY_ANY_TYPE)
  ...
  @JsonPropertyDescription(
      "String to be used for attribute writes and can contain dynamic placeholders to allow dyanmic"
