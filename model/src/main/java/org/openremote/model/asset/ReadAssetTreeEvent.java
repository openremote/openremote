...
/**
 * A client sends this event to the server to query assets that have a minimal representation for
 * usage in contexts where faster loading is necessary, expecting the server to answer "soon" with
 * an {@link AssetTreeEvent} with the results.
 */
