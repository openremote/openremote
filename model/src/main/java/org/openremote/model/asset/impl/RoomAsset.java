...
public class RoomAsset extends Asset<RoomAsset> {
    ...
    public static final AttributeDescriptor<Integer> ROOM_NUMBER = new AttributeDescriptor<>("roomNumber",
            ValueType.POSITIVE_INTEGER);

    public static final AssetDescriptor<RoomAsset> DESCRIPTOR = new AssetDescriptor<>("door", "2eaaa2",
            RoomAsset.class);
