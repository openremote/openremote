...
public class ThermostatAsset extends Asset<ThermostatAsset> {
    ...
    public static final AttributeDescriptor<Double> TEMPERATURE_SETPOINT = new AttributeDescriptor<>(
            "temperatureSetpoint", ValueType.NUMBER).withUnits(UNITS_CELSIUS).withFormat(ValueFormat.NUMBER_1_DP());
    ...
    public static final AssetDescriptor<ThermostatAsset> DESCRIPTOR = new AssetDescriptor<>("thermostat", "f5b324",
            ThermostatAsset.class);
