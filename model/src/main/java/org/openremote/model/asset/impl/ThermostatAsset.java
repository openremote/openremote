...
public class ThermostatAsset extends Asset<ThermostatAsset> {
  ...
  public static final AttributeDescriptor<Double> TEMPERATURE_SETPOINT =
      new AttributeDescriptor<>("temperatureSetpoint", ValueType.NUMBER)
  ...
  public static final AttributeDescriptor<Double> TEMPERATURE =
      new AttributeDescriptor<>(
          ...
          .withUnits(UNITS_CELSIUS)
          .withFormat(ValueFormat.NUMBER_1_DP());
  public static final AttributeDescriptor<Boolean> COOLING =
      new AttributeDescriptor<>("cooling", ValueType.BOOLEAN);

  public static final AssetDescriptor<ThermostatAsset> DESCRIPTOR =
      new AssetDescriptor<>("thermostat", "f5b324", ThermostatAsset.class);
