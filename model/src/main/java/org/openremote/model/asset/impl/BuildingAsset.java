...
public class BuildingAsset extends CityAsset {
  ...
  public static final AttributeDescriptor<String> STREET =
      new AttributeDescriptor<>("street", ValueType.TEXT);
  public static final AttributeDescriptor<String> POSTAL_CODE =
      new AttributeDescriptor<>("postalCode", ValueType.TEXT);
  public static final AttributeDescriptor<Integer> AREA =
      new AttributeDescriptor<>("area", ValueType.POSITIVE_INTEGER)
  ...
  public static final AttributeDescriptor<String> CITY =
      new AttributeDescriptor<>("city", ValueType.TEXT).withOptional(false);

  public static final AssetDescriptor<BuildingAsset> DESCRIPTOR =
      new AssetDescriptor<>("office-building", "4b5966", BuildingAsset.class);
