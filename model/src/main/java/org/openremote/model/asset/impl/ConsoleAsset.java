...
public class ConsoleAsset extends Asset<ConsoleAsset> {
  ...
  public static final AttributeDescriptor<String> CONSOLE_NAME =
      new AttributeDescriptor<>("consoleName", ValueType.TEXT);
  public static final AttributeDescriptor<String> CONSOLE_VERSION =
      new AttributeDescriptor<>("consoleVersion", ValueType.TEXT);
  public static final AttributeDescriptor<String> CONSOLE_PLATFORM =
      new AttributeDescriptor<>("consolePlatform", ValueType.TEXT);
  public static final AttributeDescriptor<ConsoleProviders> CONSOLE_PROVIDERS =
      new AttributeDescriptor<>("consoleProviders", ValueType.CONSOLE_PROVIDERS);

  public static final AssetDescriptor<ConsoleAsset> DESCRIPTOR =
      new AssetDescriptor<>("monitor-cellphone", null, ConsoleAsset.class);
  ...
  public ConsoleAsset setConsoleProvider(String name, ConsoleProvider consoleProvider) {
    ConsoleProviders providers =
        getAttributes().getValue(CONSOLE_PROVIDERS).orElse(new ConsoleProviders());
  ...
  //    public static boolean validateConsoleConfiguration(Asset<?> asset, List<ValidationFailure>
  // validationFailures) {
  ...
  // ValidationFailure(Asset.AssetTypeFailureReason.ASSET_TYPE_MISMATCH));
  //            }
  //            return false;
  //        }
  //
  ...
  //            if (validationFailures != null) {
  //                validationFailures.add(new
  // ValidationFailure(ConsoleConfiguration.ValidationFailureReason.PROVIDERS_INVALID));
  //            }
  //            valid = false;
  //        }
  //
  ...
  //            if (validationFailures != null) {
  //                validationFailures.add(new
  // ValidationFailure(ValueHolder.ValueFailureReason.VALUE_INVALID));
  //            }
  //            return false;
  //        }
  //
