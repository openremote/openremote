...
public class StandardModelProvider implements AssetModelProvider {
    ...
    public void onAssetModelFinished() {
        ...
        List<ValueConstraint> constraints = ValueType.ASSET_TYPE.getConstraints() != null
        ...
        constraints.add(new ValueConstraint.AllowedValues(
                Arrays.stream(ValueUtil.getAssetInfos(null)).map(ati -> ati.getAssetDescriptor().getName()).toArray()));
