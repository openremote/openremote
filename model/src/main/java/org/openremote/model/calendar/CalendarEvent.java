 ...
 *
 * <ul>
 *   <li><a href="https://tools.ietf.org/id/draft-jenkins-jscalendar-01.html">JSCalendar</a>
 * </ul>
 *
 ...
 * </blockquote>
 */
// TODO: Update to ical4j 4 once released with DST bug fix
// https://github.com/ical4j/ical4j/issues/117
public class CalendarEvent implements Serializable {
  ...
  public Pair<Long, Long> getNextOrActiveFromTo(Date when) {
    ...
    long whenMillis =
        when.toInstant()
            .minus(getEnd().getTime() - getStart().getTime(), ChronoUnit.MILLIS)
            .toEpochMilli();
    DateList matches =
        recurrence.getDates(
            new net.fortuna.ical4j.model.DateTime(getStart()),
