...
public class X509ProvisioningConfig
    extends ProvisioningConfig<X509ProvisioningData, X509ProvisioningConfig> {

  @JsonIgnore @Transient protected X509Certificate certificate;

  @JsonIgnore @Transient boolean valid = true;
  ...
  public synchronized X509Certificate getCertificate()
      throws IllegalStateException, CertificateException {
    if (!valid) {
      return null;
    }
