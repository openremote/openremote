...
public class ManagerTestSetup extends ManagerSetup {
  ...
  public static final int DEMO_RULE_STATES_SMART_BUILDING =
      DEMO_RULE_STATES_APARTMENT_1 + DEMO_RULE_STATES_APARTMENT_2 + DEMO_RULE_STATES_APARTMENT_3;
  public static final int DEMO_RULE_STATES_SMART_CITY = 27;
  public static final int DEMO_RULE_STATES_GLOBAL =
      DEMO_RULE_STATES_SMART_BUILDING + DEMO_RULE_STATES_SMART_OFFICE + DEMO_RULE_STATES_SMART_CITY;
  public static final int DEMO_RULE_STATES_APARTMENT_1_WITH_SCENES =
      DEMO_RULE_STATES_APARTMENT_1 + 70;
  public static final int DEMO_RULE_STATES_SMART_BUILDING_WITH_SCENES =
      DEMO_RULE_STATES_APARTMENT_1_WITH_SCENES
          + DEMO_RULE_STATES_APARTMENT_2
          + DEMO_RULE_STATES_APARTMENT_3;
  public static GeoJSONPoint SMART_OFFICE_LOCATION =
      new GeoJSONPoint(5.460315214821094, 51.44541688237109);
  ...
  public String apartment1LivingroomId =
      UniqueIdentifierGenerator.generateId("apartment1LivingroomId");
  ...
  public void onStart() throws Exception {
    ...
    groundFloor
        .getAttributes()
        .addOrReplace(new Attribute<>(Asset.LOCATION, SMART_OFFICE_LOCATION));
    ...
    thing
        ...
        .addOrReplace(
            ...
            new Attribute<>(thingLightToggleAttributeName, BOOLEAN, true)
                .addOrReplaceMeta(
                    new MetaItem<>(LABEL, "Light 1 Toggle"),
                    new MetaItem<>(STORE_DATA_POINTS, true),
                    new MetaItem<>(
                        DATA_POINTS_MAX_AGE_DAYS, OR_DATA_POINTS_MAX_AGE_DAYS_DEFAULT * 7),
    ...
    // ###################################
    EnergyOptimisationAsset electricityOptimisationAsset =
        new EnergyOptimisationAsset("Optimisation");
    ...
    electricityConsumerAsset
        .getAttribute(ElectricityAsset.POWER)
    ...
    ElectricityProducerSolarAsset electricitySolarAsset =
        new ElectricityProducerSolarAsset("Producer");
    electricitySolarAsset.setParent(electricityOptimisationAsset);
    electricitySolarAsset
        .getAttribute(ElectricityAsset.POWER)
        .ifPresent(attr -> attr.addMeta(new MetaItem<>(HAS_PREDICTED_DATA_POINTS)));
    ...
    ElectricityProducerWindAsset electricityWindAsset =
        new ElectricityProducerWindAsset("Wind Turbine");
    electricityWindAsset.setParent(electricityOptimisationAsset);
    electricityWindAsset
        .getAttribute(ElectricityAsset.POWER)
        .ifPresent(attr -> attr.addMeta(new MetaItem<>(HAS_PREDICTED_DATA_POINTS)));
    ...
    electricityBatteryAsset
        .getAttribute(ElectricityAsset.POWER_SETPOINT)
        .ifPresent(attr -> attr.addMeta(new MetaItem<>(HAS_PREDICTED_DATA_POINTS)));
    ...
    electricitySupplierAsset
        .getAttribute(ElectricityAsset.TARIFF_IMPORT)
        .ifPresent(attr -> attr.addMeta(new MetaItem<>(HAS_PREDICTED_DATA_POINTS)));
    electricitySupplierAsset
        .getAttribute(ElectricityAsset.TARIFF_EXPORT)
        .ifPresent(attr -> attr.addMeta(new MetaItem<>(HAS_PREDICTED_DATA_POINTS)));
    ...
    BuildingAsset apartment1 =
        createDemoApartment(smartBuilding, "Apartment 1", new GeoJSONPoint(5.454233, 51.446800));
        ...
        .ifPresent(
            locationAttr ->
                locationAttr
                    .getMeta()
                    .addOrReplace(
                        new MetaItem<>(ACCESS_PUBLIC_READ), new MetaItem<>(ACCESS_PUBLIC_WRITE)));
    ...
    addDemoApartmentRoomMotionSensor(
        apartment1Livingroom, true, () -> new SimulatorAgentLink(apartment1ServiceAgentId));
    ...
    addDemoApartmentRoomMotionSensor(
        apartment1Kitchen, true, () -> new SimulatorAgentLink(apartment1ServiceAgentId));
    ...
    apartment1Hallway
        ...
        .addOrReplace(
            ...
            new Attribute<>("lights", BOOLEAN, true)
                ...
                .addMeta(new MetaItem<>(ACCESS_RESTRICTED_WRITE, true)));
    addDemoApartmentRoomMotionSensor(
        apartment1Hallway, true, () -> new SimulatorAgentLink(apartment1ServiceAgentId));
    ...
    apartment1Bedroom1
        ...
        .addOrReplace(
            ...
            new Attribute<>("lights", BOOLEAN, true)
                ...
                .addMeta(new MetaItem<>(ACCESS_RESTRICTED_WRITE, true)));
    addDemoApartmentRoomCO2Sensor(
        apartment1Bedroom1, true, () -> new SimulatorAgentLink(apartment1ServiceAgentId));
    addDemoApartmentRoomHumiditySensor(
        apartment1Bedroom1, true, () -> new SimulatorAgentLink(apartment1ServiceAgentId));
    addDemoApartmentRoomThermometer(
        apartment1Bedroom1, true, () -> new SimulatorAgentLink(apartment1ServiceAgentId));
        ...
        .addOrReplace(
            ...
            new Attribute<>("lights", BOOLEAN, true)
                .addMeta(
                    ...
                    new MetaItem<>(ACCESS_RESTRICTED_WRITE, true)));
    addDemoApartmentRoomThermometer(
        apartment1Bathroom, true, () -> new SimulatorAgentLink(apartment1ServiceAgentId));
    addDemoApartmentTemperatureControl(
        apartment1Bathroom, true, () -> new SimulatorAgentLink(apartment1ServiceAgentId));
    ...
    addDemoApartmentVentilation(
        apartment1, true, () -> new SimulatorAgentLink(apartment1ServiceAgentId));
    ...
    apartment2Livingroom
        ...
        .addOrReplace(
            ...
            new Attribute<>("motionSensor", BOOLEAN, false)
                .addMeta(new MetaItem<>(LABEL, "Motion Sensor"), new MetaItem<>(RULE_STATE, true)),
            new Attribute<>("presenceDetected", BOOLEAN, false)
                .addMeta(
                    new MetaItem<>(LABEL, "Presence Detected"), new MetaItem<>(RULE_STATE, true)),
            ...
            new Attribute<>("lightSwitch", BOOLEAN, true)
                .addMeta(new MetaItem<>(LABEL, "Light Switch"), new MetaItem<>(RULE_STATE, true)),
            new Attribute<>("windowOpen", BOOLEAN, false)
                .addMeta(new MetaItem<>(ACCESS_RESTRICTED_READ, true)),
            new Attribute<>(
                    "lightSwitchTriggerTimes", TEXT.asArray(), new String[] {"1800", "0830"})
                .addMeta(
    ...
    apartment3
        .getAttributes()
        .addOrReplace(new Attribute<>(Asset.LOCATION, new GeoJSONPoint(5.453859, 51.446379)));
    ...
    PeopleCounterAsset peopleCounter1Asset =
        createDemoPeopleCounterAsset(
            "PeopleCounter 1",
            assetArea1,
            new GeoJSONPoint(5.477126, 51.439137),
    ...
    Asset<?> microphone1Asset =
        createDemoMicrophoneAsset(
            "Microphone 1",
            assetArea1,
            new GeoJSONPoint(5.478092, 51.438655),
            () -> new SimulatorAgentLink(smartCityServiceAgentId));
    microphone1Asset = assetStorageService.merge(microphone1Asset);
    microphone1Id = microphone1Asset.getId();

    Asset<?> enviroment1Asset =
        createDemoEnvironmentAsset(
            "Environment 1",
            assetArea1,
            new GeoJSONPoint(5.478907, 51.438943),
            () -> new SimulatorAgentLink(smartCityServiceAgentId));
    enviroment1Asset = assetStorageService.merge(enviroment1Asset);

    Asset<?> light1Asset =
        createDemoLightAsset("Light 1", assetArea1, new GeoJSONPoint(5.476111, 51.438492));
    light1Asset = assetStorageService.merge(light1Asset);
    light1Id = light1Asset.getId();

    Asset<?> light2Asset =
        createDemoLightAsset("Light 2", assetArea1, new GeoJSONPoint(5.477272, 51.439214));
    light2Asset
        .getAttribute(LightAsset.ON_OFF)
        .get()
        .addMeta(
            new MetaItem<>(
                ATTRIBUTE_LINKS,
                new AttributeLink[] {
                  new AttributeLink(
                      new AttributeRef(light1Asset.getId(), LightAsset.ON_OFF.getName()),
                      null,
                      null)
                }));
    ...
    Asset<?> peopleCounter3Asset =
        createDemoPeopleCounterAsset(
            "PeopleCounter 3",
            assetArea3,
            new GeoJSONPoint(5.487234, 51.447065),
            () -> new SimulatorAgentLink(smartCityServiceAgentId));
    peopleCounter3Asset = assetStorageService.merge(peopleCounter3Asset);
    peopleCounter3AssetId = peopleCounter3Asset.getId();

    LightAsset lightController_3Asset =
        createDemoLightControllerAsset(
            "LightController 3", assetArea3, new GeoJSONPoint(5.487478, 51.446979));
