...
public class TheThingsStackTestAsset extends Asset<TheThingsStackTestAsset> {
    ...
    public static final AttributeDescriptor<Double> TEMPERATURE = new AttributeDescriptor<>("temperature", ValueType.NUMBER,
        ...
        new MetaItem<>(MetaItemType.AGENT_LINK_CONFIG, new ValueType.ObjectMap() {{
            putAll(Map.of(
                "uplinkPort", 2,
                "valueFilterJsonPath", "$.uplink_message.decoded_payload.Temperature"
            ));
        }})
    ...
    public static final AttributeDescriptor<Double> RELATIVE_HUMIDITY = new AttributeDescriptor<>("relativeHumidity", ValueType.POSITIVE_NUMBER,
        ...
        new MetaItem<>(MetaItemType.AGENT_LINK_CONFIG, new ValueType.ObjectMap() {{
            putAll(Map.of(
                "uplinkPort", 2,
                "valueFilterJsonPath", "$.uplink_message.decoded_payload.Humidity"
            ));
        }})
    );
    public static final AttributeDescriptor<String> ERRORS = new AttributeDescriptor<>("errors", ValueType.TEXT,
        ...
        new MetaItem<>(MetaItemType.AGENT_LINK_CONFIG, new ValueType.ObjectMap() {{
            putAll(Map.of(
                "uplinkPort", 2,
                "valueFilterJsonPath", "$.uplink_message.decoded_payload.Errors"
            ));
        }})
    );
    ...
    public static final AssetDescriptor<TheThingsStackTestAsset> DESCRIPTOR = new AssetDescriptor<>("molecule-co2", "f18546", TheThingsStackTestAsset.class);
