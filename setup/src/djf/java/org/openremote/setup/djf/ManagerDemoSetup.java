...
import org.openremote.model.value.ForecastConfigurationWeightedExponentialAverage.ExtendedPeriodAndDuration;
            ...
            thermostatAsset.getAttributes().addOrReplace(
                new Attribute<>("temperature" + i, ValueType.NUMBER)
                    .addOrReplaceMeta(
                        ...
                        new MetaItem<ForecastConfiguration>(MetaItemType.FORECAST,
                            new ForecastConfigurationWeightedExponentialAverage(
                                new ExtendedPeriodAndDuration("PT1H"),
                                4,
                                new ExtendedPeriodAndDuration("PT1H"),
                                4
                            )
                        ...
                        new MetaItem<>(MetaItemType.FORMAT, ValueFormat.BOOLEAN_AS_0_1()),
