...
public class SoilSensorAsset extends Asset<SoilSensorAsset> {
    ...
    public static final AttributeDescriptor<Integer> SOIL_TENSION_MEASURED = new AttributeDescriptor<>(
            "soilTensionMeasured", ValueType.POSITIVE_INTEGER).withUnits(UNITS_KILO, UNITS_PASCAL);
    public static final AttributeDescriptor<Integer> SOIL_TENSION_MIN = new AttributeDescriptor<>("soilTensionMin",
            ValueType.POSITIVE_INTEGER).withUnits(UNITS_KILO, UNITS_PASCAL)
    ...
    public static final AttributeDescriptor<Double> TEMPERATURE = new AttributeDescriptor<>("temperature",
            ValueType.NUMBER).withUnits(UNITS_CELSIUS);
    public static final AttributeDescriptor<Double> SALINITY = new AttributeDescriptor<>("salinity", ValueType.NUMBER);

    public static final AssetDescriptor<SoilSensorAsset> DESCRIPTOR = new AssetDescriptor<>("water-percent", "993333",
            SoilSensorAsset.class);
