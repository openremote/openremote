...
public class HarvestRobotAsset extends Asset<HarvestRobotAsset> {
    ...
    public static final ValueDescriptor<OperationMode> OPERATION_MODE_VALUE = new ValueDescriptor<>("operationMode",
            OperationMode.class);
    public static final AttributeDescriptor<OperationMode> OPERATION_MODE = new AttributeDescriptor<>("operationMode",
    ...
    public static final ValueDescriptor<VegetableType> VEGETABLE_TYPE_VALUE = new ValueDescriptor<>("vegetableType",
            VegetableType.class);
    public static final AttributeDescriptor<VegetableType> VEGETABLE_TYPE = new AttributeDescriptor<>("vegetableType",
            VEGETABLE_TYPE_VALUE);
    ...
    public static final AttributeDescriptor<Double> SPEED = new AttributeDescriptor<>("speed",
            ValueType.POSITIVE_NUMBER).withUnits(UNITS_KILO, UNITS_METRE, UNITS_PER, UNITS_HOUR);
    ...
    public static final AssetDescriptor<HarvestRobotAsset> DESCRIPTOR = new AssetDescriptor<>("robot-industrial",
            "38761d", HarvestRobotAsset.class);
