...
import org.openremote.energy.asset.ElectricityProducerWindAsset
import org.openremote.manager.asset.AssetProcessingService
import org.openremote.manager.asset.AssetStorageService
import org.openremote.manager.datapoint.AssetPredictedDatapointService
import org.openremote.energy.manager.ForecastSolarService
import org.openremote.energy.manager.ForecastWindService
...
import org.openremote.energy.test.EnergyManagerTestSetup
...
import static org.openremote.energy.manager.ForecastWindService.OR_OPEN_WEATHER_API_APP_ID
...
class ForecastWindServiceTest extends Specification implements ManagerContainerTrait {
    ...
    def "Test adding and removing asset with enabled attributes"() {
        ...
        def managerTestSetup = container.getService(SetupService.class).getTaskOfType(EnergyManagerTestSetup.class)
