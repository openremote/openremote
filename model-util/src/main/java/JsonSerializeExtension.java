 ...
 *
 * <ul>
 *   <li>{@link JsonSerialize#as}
 *   <li>{@link JsonSerialize#converter}
 * </ul>
 */
                                  ...
                                  p -> {
                                    ...
                                    if (jsonSerialize != null) {
                                      ...
                                      if (jsonSerialize.converter() != Converter.None.class) {
                                        // Type info is not accessible with reflection so
                                        // instantiate the converter
                                        Method convertMethod =
                                            Arrays.stream(jsonSerialize.converter().getMethods())
                                        ...
                                        if (convertMethod != null) {
                                          ...
                                          return new PropertyModel(
                                              p.getName(),
                                              convertMethod.getGenericReturnType(),
                                              p.isOptional(),
                                              p.getAccess(),
                                              p.getOriginalMember(),
                                              p.getPullProperties(),
