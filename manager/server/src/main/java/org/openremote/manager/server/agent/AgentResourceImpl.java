...
public class AgentResourceImpl extends WebResource implements AgentResource {
    ...
    @Override
    public Agent get(@BeanParam RequestParams requestParams, String agentId) {
        return agentService.get(agentId);
    }

    @Override
    public void create(@BeanParam RequestParams requestParams, Agent agent) {
        agentService.create(agent);
    }

    @Override
    public void update(@BeanParam RequestParams requestParams, String agentId, Agent agent) {
        agentService.update(agent);

    }

    @Override
    public void delete(@BeanParam RequestParams requestParams, String agentId) {
