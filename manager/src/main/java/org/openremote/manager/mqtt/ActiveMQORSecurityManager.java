...
/**
 * A security manager that uses the {@link
 * org.openremote.manager.security.MultiTenantJaasCallbackHandler} with a dynamic {@link
 * org.keycloak.adapters.KeycloakDeployment} resolver.
 *
 * <p>Unfortunately lots of private methods and fields in super class.
 */
public class ActiveMQORSecurityManager extends ActiveMQJAASSecurityManager {
  ...
  public ActiveMQORSecurityManager(
      ...
      Function<String, KeycloakDeployment> deploymentResolver,
  ...
  protected Subject getAuthenticatedSubject(
      String user,
      String password,
      ...
      if (securityDomain != null) {
        lc =
            new LoginContext(
                securityDomain,
                null,
                new MultiTenantJaasCallbackHandler(
                    deploymentResolver, realm, user, password, remotingConnection),
                null);
      } else if (certificateConfigName != null
          && certificateConfigName.length() > 0
