...
public class MQTTBrokerService extends RouteBuilder
  ...
  public void init(Container container) throws Exception {
    ...
    String serverURI =
        new URIBuilder()
            ...
            .setParameter(
                "defaultMqttSessionExpiryInterval", "0") // Don't support retained sessions
            .build()
            .toString();
    ...
    // Configure global address settings - aggressively cleanup queues (don't support resumable
    // sessions)
                ...
                return new AppConfigurationEntry[] {
                  new AppConfigurationEntry(
                      ...
                      Map.of(
                          ...
                          ANONYMOUS_USERNAME)),
                  new AppConfigurationEntry(
                      MultiTenantClientCredentialsGrantsLoginModule.class.getName(),
                      AppConfigurationEntry.LoginModuleControlFlag.REQUISITE,
                      Map.of(
                          MultiTenantClientCredentialsGrantsLoginModule.INCLUDE_REALM_ROLES_OPTION,
                          "true",
                          AbstractKeycloakLoginModule.ROLE_PRINCIPAL_CLASS_OPTION,
                          RolePrincipal.class.getName())),
                  new AppConfigurationEntry(
                      PrincipalConversionLoginModule.class.getName(),
                      AppConfigurationEntry.LoginModuleControlFlag.REQUISITE,
                      Map.of(
                          PrincipalConversionLoginModule.PRINCIPAL_CLASS_LIST,
  ...
  public void processUserAssetLinkChange(
    ...
    if (subject != null
        && KeycloakIdentityProvider.getSecurityContext(subject)
            .getToken()
            .getRealmAccess()
