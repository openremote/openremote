...
public class SchemaExporter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Container container = new Container(new ManagerPersistenceService() {

            @Override
            protected void openDatabase(org.openremote.model.Container container, Database database, String username,
            ...
            public void start(org.openremote.model.Container container) throws Exception {
                ...
                createSchemaProperties.put("javax.persistence.schema-generation.scripts.create-target",
