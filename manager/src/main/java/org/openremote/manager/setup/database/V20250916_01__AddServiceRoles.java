...
/**
 * Flyway migration that adds the {@code read:services} and {@code write:services} client roles to
 * the {@code openremote} client of every realm and wires them into the existing {@code read}/{@code
