...
/**
 * Flyway migration script to add write:services and read:services roles using Keycloak admin API.
 */
public class V20250916_01__AddServiceRoles extends BaseJavaMigration {
  ...
  public void migrate(Context context) throws Exception {
    ...
    String adminPassword =
        System.getenv()
            .getOrDefault(
                IdentityProvider.OR_ADMIN_PASSWORD, IdentityProvider.OR_ADMIN_PASSWORD_DEFAULT);
