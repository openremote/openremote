...
public class RulesService extends RouteBuilder implements ContainerService {
  ...
  public void init(Container container) throws Exception {
    ...
    String defaultEventExpires =
        getString(container.getConfig(), OR_RULE_EVENT_EXPIRES, OR_RULE_EVENT_EXPIRES_DEFAULT);
  ...
  protected RulesEngine<GlobalRuleset> deployGlobalRuleset(GlobalRuleset ruleset) {
    synchronized (ENGINE_LOCK) {
      ...
      if (isNewEngine) {
        ...
        attributeEvents.forEach(
            assetState -> finalEngine.insertOrUpdateAttributeInfo(assetState, true));
      }
