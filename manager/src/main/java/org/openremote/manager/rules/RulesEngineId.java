...
public class RulesEngineId<T extends Ruleset> {
    ...
    public boolean equals(Object o) {
        ...
        return scope == that.scope && Objects.equals(realm, that.realm) && Objects.equals(assetId, that.assetId);
    }
    ...
    public String toString() {
        return getClass().getSimpleName() + "{" + "scope=" + scope.getSimpleName() + ", realm='" + realm + '\''
                + ", assetId='" + assetId + '\'' + '}';
    }
}
