 ...
 *
 * <p>An engine in {@link org.openremote.model.rules.GlobalRuleset} scope has no {@link #realm} or
 * {@link #assetId}. An engine {@link RealmRuleset} scope has only {@link #realm}. An engine in
 * {@link org.openremote.model.rules.AssetRuleset} scope has both.
 */
public class RulesEngineId<T extends Ruleset> {
  ...
  public Optional<String> getId() {
    return scope == RealmRuleset.class
        ? getRealm()
        : scope == AssetRuleset.class ? getAssetId() : Optional.empty();
  }
