...
public class SystemHealthStatusProvider implements HealthStatusProvider {
  ...
  public Object getHealthStatus() {
    ...
    objectValue.put(
        "totalPhysicalMemoryMB", operatingSystemMXBean.getTotalMemorySize() / (1024F * 1024F));
    objectValue.put(
        "freePhysicalMemoryMB", operatingSystemMXBean.getFreeMemorySize() / (1024F * 1024F));
    objectValue.put(
        "committedVirtualMemoryMB",
        operatingSystemMXBean.getCommittedVirtualMemorySize() / (1024F * 1024F));
    objectValue.put(
        "totalSwapSpaceMB", operatingSystemMXBean.getTotalSwapSpaceSize() / (1024F * 1024F));
    objectValue.put(
        "freeSwapSpaceMB", operatingSystemMXBean.getFreeSwapSpaceSize() / (1024F * 1024F));
