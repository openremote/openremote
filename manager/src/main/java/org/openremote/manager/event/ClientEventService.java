...
public class ClientEventService extends RouteBuilder implements ContainerService {
  ...
  public static final String WEBSOCKET_URI =
      "undertow://ws://0.0.0.0/websocket/events?fireWebSocketChannelEvents=true&sendTimeout=15000&keepAlive=false"; // Host is not used as existing undertow instance is utilised
