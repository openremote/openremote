 ...
 * {@link KeycloakDeploymentCallback}. Unfortunately the fields are private so had to copy most of
 * the code below.
 */
public class MultiTenantJaasCallbackHandler implements CallbackHandler {
  ...
  public MultiTenantJaasCallbackHandler(
  ...
  public void handle(Callback[] callbacks) throws IOException, UnsupportedCallbackException {
    for (Callback callback : callbacks) {
      if (callback instanceof PasswordCallback) {
        ...
        if (peerSubject != null) {
          for (KerberosPrincipal principal :
              peerSubject.getPrivateCredentials(KerberosPrincipal.class)) {
