...
public class LDAPComponentBuilder {
  ...
  public LDAPComponentBuilder setUseKerberosForPasswordAuthentication(
      boolean useKerberosForPasswordAuthentication) {
    ldapConfig.add(
        "useKerberosForPasswordAuthentication",
        String.valueOf(useKerberosForPasswordAuthentication));
    return this;
  }
  ...
  public LDAPComponentBuilder setMemberShipAttributeType(
  ...
  public LDAPComponentBuilder setUserRolesRetrieveStrategy(
  ...
  public LDAPComponentBuilder setDropNonExistingGroupsDuringSync(
      boolean dropNonExistingGroupsDuringSync) {
    ldapConfig.add(
        "drop.non.existing.groups.during.sync", String.valueOf(dropNonExistingGroupsDuringSync));
    return this;
  }
