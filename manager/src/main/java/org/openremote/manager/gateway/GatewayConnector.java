            ...
            () -> {
              sendMessageToGateway(
                  new GatewayTunnelStartRequestEvent(
                      ...
                      gatewayService.getTunnelSSHPort(),
                      tunnelInfo));
      ...
      case CREATE, READ, UPDATE -> {
        ...
        synchronized (pendingAssetMerges) {
          if (pendingAssetMerges.containsKey(assetId)) {
            ...
            Map.Entry<String, Asset<?>> pendingAssetMergeEntry =
                pendingAssetMerges.entrySet().stream()
                    .filter(entry -> entry.getKey().equals(assetId))
                    .findFirst()
                    .get();
