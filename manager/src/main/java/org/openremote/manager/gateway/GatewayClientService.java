    ...
    public void init(Container container) throws Exception {
        ...
        if (!TextUtil.isNullOrEmpty(tunnelKeyFile)) {
            ...
            if (f.exists()) {
                ...
                tunnelFactory = new MINAGatewayTunnelFactory(org.openremote.container.Container.EXECUTOR, org.openremote.container.Container.SCHEDULED_EXECUTOR, f, localhostRewrite);
            } else {
