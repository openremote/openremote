...
public class GatewayServiceResourceImpl extends ManagerWebResource implements GatewayServiceResource {
    ...
    public GatewayServiceResourceImpl(TimerService timerService, ManagerIdentityService identityService,
            GatewayService gatewayService, AssetStorageService assetStorageService) {
    ...
    public GatewayTunnelInfo[] getAllActiveTunnelInfos(RequestParams requestParams, String realm) {
        ...
        return this.gatewayService.getTunnelInfos().stream().filter(tunnel -> tunnel.getRealm().equals(realm))
    ...
    @Override
    public GatewayTunnelInfo getActiveTunnelInfo(RequestParams requestParams, String realm, String gatewayId,
        ...
        return this.gatewayService.getTunnelInfos().stream()
                .filter(tunnel -> tunnel.getRealm().equals(realm) && tunnel.getGatewayId().equals(gatewayId)
                        && tunnel.getTarget().equals(target) && tunnel.getTargetPort() == targetPort)
