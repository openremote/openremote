...
public class AssetAnomalyDatapointResourceImpl extends ManagerWebResource implements AssetAnomalyDatapointResource {

    private static final Logger LOG = Logger.getLogger(AssetAnomalyDatapointResourceImpl.class.getName());

    protected final AssetStorageService assetStorageService;
    protected final AssetAnomalyDatapointService assetAnomalyDatapointService;

    public AssetAnomalyDatapointResourceImpl(TimerService timerService,
                                             ManagerIdentityService identityService,
                                             AssetStorageService assetStorageService,
                                             AssetAnomalyDatapointService assetAnomalyDatapointService) {
        super(timerService, identityService);
        this.assetStorageService = assetStorageService;
        this.assetAnomalyDatapointService = assetAnomalyDatapointService;
    }


    public AttributeAnomaly[] getAnomalyDatapoints(@BeanParam RequestParams requestParams,
                                                   String assetId,
        ...
        try {
            ...
            return assetAnomalyDatapointService.getAnommalies(assetId, attribute, query);
