...
public class AssetPredictedDatapointResourceImpl extends ManagerWebResource implements AssetPredictedDatapointResource {
    ...
    public AssetPredictedDatapointResourceImpl(TimerService timerService, ManagerIdentityService identityService,
            AssetStorageService assetStorageService, AssetPredictedDatapointService assetPredictedDatapointService) {
    ...
    @Override
    public ValueDatapoint<?>[] getPredictedDatapoints(@BeanParam RequestParams requestParams, String assetId,
    ...
    @Override
    public void writePredictedDatapoints(RequestParams requestParams, String assetId, String attributeName,
