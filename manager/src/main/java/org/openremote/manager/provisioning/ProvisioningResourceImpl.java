...
public class ProvisioningResourceImpl extends ManagerWebResource implements ProvisioningResource {
    ...
    public ProvisioningResourceImpl(ProvisioningService provisioningService, TimerService timerService,
    ...
    @Override
    public void updateProvisioningConfig(RequestParams requestParams, Long id,
