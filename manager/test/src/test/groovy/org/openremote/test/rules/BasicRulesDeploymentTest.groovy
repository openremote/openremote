...
class BasicRulesDeploymentTest extends Specification implements ManagerContainerTrait {
    ...
    def "Check basic rules engine deployment"() {
        ...
        def rulesImport = new BasicRulesImport(rulesStorageService, keycloakDemoSetup, managerDemoSetup)
        ...
        rulesDefinition = rulesStorageService.findById(TenantRulesDefinition.class, rulesImport.customerBRulesDefinitionId)
        ...
        rulesStorageService.delete(AssetRulesDefinition.class, rulesImport.apartment1RulesDefinitionId)
