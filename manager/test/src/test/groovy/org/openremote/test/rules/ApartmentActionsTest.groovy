...
class ApartmentActionsTest extends Specification implements ManagerContainerTrait {
    ...
    def "Vacation Mode"() {
        ...
        conditions.eventually {
            ...
            assert new AssetAttributes(asset).get("vacationDays").valueAsInteger == 5
        }
        ...
        conditions.eventually {
            def asset = assetStorageService.find(managerDemoSetup.apartment1Id, true)
            assert new AssetAttributes(asset).get("vacationDays").valueAsInteger == 4
        }
        ...
        while (remainingDays > 0) {
            ...
            conditions.eventually {
                def asset = assetStorageService.find(managerDemoSetup.apartment1Id, true)
                assert new AssetAttributes(asset).get("vacationDays").valueAsInteger == remainingDays
            }
        }
