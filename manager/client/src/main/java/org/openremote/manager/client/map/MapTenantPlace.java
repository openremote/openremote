...
public class MapTenantPlace extends MapPlace {
    ...
    @Prefix("mapTenant")
    public static class Tokenizer implements PlaceTokenizer<MapTenantPlace> {

        @Override
        public MapTenantPlace getPlace(String token) {
            return new MapTenantPlace(token != null && token.length() > 0 ? token : null);
        }
