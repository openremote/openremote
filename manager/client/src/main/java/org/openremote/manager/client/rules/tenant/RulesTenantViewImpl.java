...
public class RulesTenantViewImpl extends FormViewImpl implements RulesTenantView {

    private static final Logger LOG = Logger.getLogger(RulesTenantViewImpl.class.getName());

    interface UI extends UiBinder<FlexSplitPanel, RulesTenantViewImpl> {
    }
    ...
    @Inject
    public RulesTenantViewImpl(AssetBrowser assetBrowser, Provider<ConfirmationDialog> confirmationDialogProvider) {
