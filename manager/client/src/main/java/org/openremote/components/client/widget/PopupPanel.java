...
public class PopupPanel extends SimplePanel implements SourcesPopupEvents,
  ...
  static class ResizeAnimation extends Animation {
    ...
    protected void onComplete() {
      ...
      curPanel.getElement().getStyle().setProperty("overflow", "auto");  // TODO: In the history of the web, has "visible overflow" ever been desirable?
    }
    ...
    private void onInstantaneousRun() {
      ...
      curPanel.getElement().getStyle().setProperty("overflow", "visible");  // TODO: In the history of the web, has "visible overflow" ever been desirable?
    }
  }
   ...
   */
  private static final String DEFAULT_STYLENAME = "or-PopupPanel";
