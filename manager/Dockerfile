...
ENV OR_SSL_PORT ${OR_SSL_PORT:-443}
...
ENV OR_CONSOLE_APP_CONFIG_DOCROOT ${OR_CONSOLE_APP_CONFIG_DOCROOT:-/deployment/manager/consoleappconfig}
...
ENV OR_JAVA_OPTS ${OR_JAVA_OPTS:--Xms400m -Xmx400m \
