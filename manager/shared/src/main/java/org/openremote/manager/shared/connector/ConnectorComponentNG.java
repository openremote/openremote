 ...
 */
public interface ConnectorComponentNG extends ConnectorComponent {

    public static final String HEADER_DISCOVERY_START = ConnectorComponentNG.class.getCanonicalName() + ".HEADER_DISCOVERY_START";
    public static final String HEADER_DISCOVERY_STOP = ConnectorComponentNG.class.getCanonicalName() + ".HEADER_DISCOVERY_STOP";
    public static final String HEADER_INVENTORY_ACTION = ConnectorComponentNG.class.getCanonicalName() + ".HEADER_INVENTORY_ACTION";
    public static final String HEADER_DEVICE_ACTION = ConnectorComponentNG.class.getCanonicalName() + ".HEADER_DEVICE_ACTION";
