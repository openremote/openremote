...
class ViewController: UIViewController {
    ...
    @IBAction func showLoginPage(_ sender: Any) {
        let http = Http()
        let keycloakConfig = Config.init(base: "http://192.168.99.100:8080/auth", authzEndpoint: "realms/master/protocol/openid-connect/auth", redirectURL: "http://192.168.99.100:8080/master", accessTokenEndpoint: "realms/master/protocol/openid-connect/token", clientId: "or-manager", refreshTokenEndpoint: "realms/master/protocol/openid-connect/token", revokeTokenEndpoint: "realms/master/protocol/openid-connect/logout", isOpenIDConnect: true, userInfoEndpoint: nil, scopes: ["openid", "email", "profile"], clientSecret: nil, accountId: nil, isWebView: true)
