...
public class ChannelConsumerLink implements ChannelListener, ControllerListener {
  ...
  public static ChannelConsumerLink createLink(
      int nodeId,
      int endpoint,
      String channelName,
    ...
    ChannelConsumerLink link =
        new ChannelConsumerLink(nodeId, endpoint, channelName, channel, consumer, controller);
    if (channel != null) {
