...
public final class ConfigModelSubscriptionDeleteAll extends ConfigMessage {
  ...
  public static final Logger LOG =
      Logger.getLogger(ConfigModelSubscriptionDeleteAll.class.getName());
   ...
   */
  public ConfigModelSubscriptionDeleteAll(final int elementAddress, final int modelIdentifier)
