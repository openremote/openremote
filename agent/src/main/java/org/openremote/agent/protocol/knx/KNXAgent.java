...
public class KNXAgent extends Agent<KNXAgent, KNXProtocol, KNXAgentLink> {
    ...
    public static final ValueDescriptor<String> SOURCE_ADDRESS_VALUE = new ValueDescriptor<>("kNXMessageSourceAddress",
            String.class);
    ...
    public static final AttributeDescriptor<Boolean> ROUTING_MODE = new AttributeDescriptor<>("routingMode",
            ValueType.BOOLEAN);
    public static final AttributeDescriptor<String> MESSAGE_SOURCE_ADDRESS = new AttributeDescriptor<>(
            "messageSourceAddress", SOURCE_ADDRESS_VALUE);
