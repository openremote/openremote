...
/**
 * This is an abstract protocol for creating TCP Server protocols. This allows TCP clients to
 * connect and exchange data. It is up to the concrete implementations whether or not linked {@link
 * Attribute}s can be used with this protocol and to define the semantics of these linked
 * attributes.
 */
public abstract class AbstractTCPServerProtocol<
        R,
        S extends AbstractTCPServer<R>,
        T extends AbstractTCPServerProtocol<R, S, T, U, V>,
        U extends AbstractTCPServerAgent<U, T, V>,
        V extends AgentLink<?>>
