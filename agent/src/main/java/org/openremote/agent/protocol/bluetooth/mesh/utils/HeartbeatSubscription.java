...
public class HeartbeatSubscription extends Heartbeat {
  ...
  public String getCountLogDescription() {
    if (countLog == 0x00 || countLog == 0x01) return String.valueOf(countLog);
  ...
  public String getPeriodLogDescription() {
    ...
    else if (periodLog == 0x01) return "1";
    ...
    } else if (periodLog == 0x11) return "65535";
    else return "Invalid";
  }
  ...
  public Short getPeriodLog2Period() {
    ...
    } else if (periodLog == 0x11) return (short) 0xFFFF;
