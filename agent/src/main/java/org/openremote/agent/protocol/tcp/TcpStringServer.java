...
/**
 * This is an {@link TcpServer} implementation that handles {@link String} messages.
 * <p>
 * Uses {@link DelimiterBasedFrameDecoder} and {@link StringDecoder}.
 */
public class TcpStringServer extends TcpServer<String> {
    ...
    protected void addDecoders(SocketChannel channel) {
        ...
        channel.pipeline().addLast(
            new DelimiterBasedFrameDecoder(maxFrameLength, stripDelimiter, Unpooled.wrappedBuffer(delimiter.getBytes()))
        );
