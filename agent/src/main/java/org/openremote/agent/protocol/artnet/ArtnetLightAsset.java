...
public class ArtnetLightAsset extends LightAsset {
  ...
  public static final AttributeDescriptor<Integer> LED_COUNT =
      new AttributeDescriptor<>("lEDCount", ValueType.POSITIVE_INTEGER);
  public static final AttributeDescriptor<Integer> LIGHT_ID =
      new AttributeDescriptor<>("lightId", ValueType.POSITIVE_INTEGER);
  public static final AttributeDescriptor<Integer> GROUP_ID =
      new AttributeDescriptor<>("groupId", ValueType.POSITIVE_INTEGER);
  public static final AttributeDescriptor<Integer> UNIVERSE =
      new AttributeDescriptor<>("universe", ValueType.POSITIVE_INTEGER);
  public static final AttributeDescriptor<String[]> REQUIRED_VALUES =
      new AttributeDescriptor<>("requiredValues", ValueType.TEXT.asArray());

  public static final AssetDescriptor<ArtnetLightAsset> DESCRIPTOR =
      new AssetDescriptor<>("lightbulb", "e6688a", ArtnetLightAsset.class);

  @Transient @JsonIgnore private Map<String, Integer> receivedValues;
  ...
  //                    new HashMap<String,
  // Integer>(this.receivedValues).keySet().forEach(keyIndicator -> {
