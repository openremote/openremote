...
public class TypeMapper {
  ...
  static {
    ...
    typeMap.put(
        ...
        new TypeInfo(ValueType.NUMBER, units(UNITS_CELSIUS), ValueFormat.NUMBER_1_DP()));
    typeMap.put(
        ChannelType.TEMPERATURE_FAHRENHEIT,
        new TypeInfo(ValueType.NUMBER, units(UNITS_FAHRENHEIT), ValueFormat.NUMBER_1_DP()));
    typeMap.put(ChannelType.PERCENTAGE, new TypeInfo(ValueType.NUMBER, units(UNITS_PERCENTAGE)));
    typeMap.put(
        ChannelType.LUMINANCE_PERCENTAGE,
        new TypeInfo(
            ValueType.INTEGER,
    ...
    typeMap.put(
        ChannelType.POWER_BTU_H,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_BTU, UNITS_PER, UNITS_HOUR)));
    typeMap.put(
        ChannelType.HUMIDITY_PERCENTAGE, new TypeInfo(ValueType.INTEGER, units(UNITS_PERCENTAGE)));
    typeMap.put(
        ChannelType.HUMIDITY_ABSOLUTE,
        new TypeInfo(ValueType.INTEGER.withUnits(UNITS_GRAM, UNITS_PER, UNITS_METRE, UNITS_CUBED)));
    typeMap.put(
        ChannelType.SPEED_MS,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_METRE, UNITS_PER, UNITS_SECOND)));
    typeMap.put(
        ChannelType.SPEED_MPH,
        new TypeInfo(ValueType.INTEGER.withUnits(UNITS_MILE, UNITS_PER, UNITS_HOUR)));
    typeMap.put(
        ChannelType.DIRECTION_DECIMAL_DEGREES,
        new TypeInfo(ValueType.INTEGER, units(UNITS_DEGREE)));
    typeMap.put(
        ChannelType.PRESSURE_KPA,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_KILO, UNITS_PASCAL)));
    typeMap.put(ChannelType.PRESSURE_IN_HG, new TypeInfo(ValueType.NUMBER, units(UNITS_IN_HG)));
    typeMap.put(
        ChannelType.SOLAR_RADIATION_WATT_M2,
        new TypeInfo(
            ValueType.NUMBER.withUnits(UNITS_WATT, UNITS_PER, UNITS_METRE, UNITS_SQUARED)));
    typeMap.put(
        ChannelType.DEW_POINT_CELSIUS, new TypeInfo(ValueType.NUMBER, units(UNITS_CELSIUS)));
    typeMap.put(
        ChannelType.DEW_POINT_FAHRENHEIT, new TypeInfo(ValueType.NUMBER, units(UNITS_FAHRENHEIT)));
    typeMap.put(
        ChannelType.RAINFALL_MMPH,
        new TypeInfo(ValueType.INTEGER.withUnits(UNITS_MILLI, UNITS_METRE, UNITS_PER, UNITS_HOUR)));
    typeMap.put(
        ChannelType.RAINFALL_INPH,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_INCH, UNITS_PER, UNITS_HOUR)));
    ...
    typeMap.put(
        ChannelType.WEIGHT_KG, new TypeInfo(ValueType.NUMBER.withUnits(UNITS_KILO, UNITS_GRAM)));
    ...
    typeMap.put(
        ChannelType.VOLTAGE_MV, new TypeInfo(ValueType.NUMBER.withUnits(UNITS_MILLI, UNITS_VOLT)));
    typeMap.put(ChannelType.CURRENT_A, new TypeInfo(ValueType.NUMBER, units(UNITS_AMP)));
    typeMap.put(
        ChannelType.CURRENT_MA, new TypeInfo(ValueType.NUMBER.withUnits(UNITS_MILLI, UNITS_AMP)));
    typeMap.put(
        ChannelType.CO2_PPM, new TypeInfo(ValueType.INTEGER, units(UNITS_PART_PER_MILLION)));
    typeMap.put(
        ChannelType.AIR_FLOW_CMPH,
        new TypeInfo(
            ValueType.NUMBER.withUnits(UNITS_METRE, UNITS_CUBED, UNITS_PER, UNITS_MINUTE)));
    typeMap.put(
        ChannelType.AIR_FLOW_CFTPM,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_FOOT, UNITS_CUBED, UNITS_PER, UNITS_MINUTE)));
    typeMap.put(ChannelType.TANK_CAPACITY_L, new TypeInfo(ValueType.NUMBER, units(UNITS_LITRE)));
    typeMap.put(
        ChannelType.TANK_CAPACITY_CBM,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_METRE, UNITS_CUBED)));
    ...
    typeMap.put(
        ...
        new TypeInfo(ValueType.POSITIVE_NUMBER.withUnits(UNITS_CENTI, UNITS_METRE)));
    typeMap.put(
        ChannelType.DISTANCE_FT, new TypeInfo(ValueType.POSITIVE_NUMBER, units(UNITS_FOOT)));
    typeMap.put(
        ChannelType.ANGLE_POSITION_PERCENT,
        new TypeInfo(
            ValueType.INTEGER,
            units(UNITS_PERCENTAGE),
            null,
    ...
    typeMap.put(
        ...
        new TypeInfo(ValueType.NUMBER, units(UNITS_CELSIUS)));
    typeMap.put(
        ChannelType.WATER_TEMPERATURE_FAHRENHEIT,
        new TypeInfo(ValueType.NUMBER, units(UNITS_FAHRENHEIT)));
    typeMap.put(
        ChannelType.SOIL_TEMPERATURE_CELSIUS, new TypeInfo(ValueType.NUMBER, units(UNITS_CELSIUS)));
    typeMap.put(
    ...
    typeMap.put(
        ChannelType.LOUDNESS_DBA, new TypeInfo(ValueType.NUMBER, units(UNITS_DECIBEL_ATTENUATED)));
    typeMap.put(
        ChannelType.MOISTURE_PERCENTAGE, new TypeInfo(ValueType.NUMBER, units(UNITS_PERCENTAGE)));
    ...
    typeMap.put(
        ChannelType.FREQUENCY_KHZ,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_KILO, UNITS_HERTZ)));
    ...
    typeMap.put(
        ChannelType.SOIL_HUMIDITY_PERCENTAGE,
        new TypeInfo(ValueType.NUMBER, units(UNITS_PERCENTAGE)));
    ...
    typeMap.put(
        ChannelType.MUSCLE_MASS_KG,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_KILO, UNITS_GRAM)));
    typeMap.put(
        ChannelType.FAT_MASS_KG, new TypeInfo(ValueType.NUMBER.withUnits(UNITS_KILO, UNITS_GRAM)));
    typeMap.put(
        ChannelType.BONE_MASS_KG, new TypeInfo(ValueType.NUMBER.withUnits(UNITS_KILO, UNITS_GRAM)));
    typeMap.put(
        ChannelType.TOTAL_BODY_WATER_KG,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_KILO, UNITS_GRAM)));
    typeMap.put(
        ChannelType.BASIC_METABOLIC_RATE_JOULE, new TypeInfo(ValueType.NUMBER, units(UNITS_JOULE)));
    typeMap.put(ChannelType.BODY_MASS_INDEX, new TypeInfo(ValueType.NUMBER));
    typeMap.put(
        ChannelType.ACCELERATION_X_MPSS,
        new TypeInfo(
            ValueType.NUMBER.withUnits(UNITS_METRE, UNITS_PER, UNITS_SECOND, UNITS_SQUARED)));
    typeMap.put(
        ChannelType.ACCELERATION_Y_MPSS,
        new TypeInfo(
            ValueType.NUMBER.withUnits(UNITS_METRE, UNITS_PER, UNITS_SECOND, UNITS_SQUARED)));
    typeMap.put(
        ChannelType.ACCELERATION_Z_MPSS,
        new TypeInfo(
            ValueType.NUMBER.withUnits(UNITS_METRE, UNITS_PER, UNITS_SECOND, UNITS_SQUARED)));
    typeMap.put(
        ChannelType.SMOKE_DENSITY_PERCENTAGE,
        new TypeInfo(ValueType.NUMBER, units(UNITS_PERCENTAGE)));
    typeMap.put(
        ChannelType.WATER_FLOW_LPH,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_LITRE, UNITS_PER, UNITS_HOUR)));
    typeMap.put(
        ChannelType.WATER_PRESSURE_KPA,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_KILO, UNITS_PASCAL)));
    ...
    typeMap.put(
        ...
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_KILO, UNITS_WATT, UNITS_PER, UNITS_HOUR)));
    typeMap.put(
        ChannelType.ELECTRIC_METER_ENERGY_KVAH,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_KILO, UNITS_WATT, UNITS_PER, UNITS_HOUR)));
    typeMap.put(
        ChannelType.ELECTRIC_METER_POWER_W, new TypeInfo(ValueType.NUMBER, units(UNITS_WATT)));
    typeMap.put(ChannelType.ELECTRIC_METER_PULSE_COUNT, new TypeInfo(ValueType.NUMBER));
    typeMap.put(
        ChannelType.ELECTRIC_METER_VOLTAGE_V, new TypeInfo(ValueType.NUMBER, units(UNITS_VOLT)));
    typeMap.put(
        ChannelType.ELECTRIC_METER_CURRENT_A, new TypeInfo(ValueType.NUMBER, units(UNITS_AMP)));
    typeMap.put(ChannelType.ELECTRIC_METER_POWER_FACTOR, new TypeInfo(ValueType.NUMBER));
    typeMap.put(
        ChannelType.ELECTRIC_METER_POWER_KVAR,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_KILO, UNITS_WATT)));
    typeMap.put(
    ...
    // Gas Meter
    typeMap.put(
        ChannelType.GAS_METER_VOLUME_CM,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_METRE, UNITS_CUBED)));
    typeMap.put(
        ChannelType.GAS_METER_VOLUME_CFT,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_FOOT, UNITS_CUBED)));
    typeMap.put(ChannelType.GAS_METER_PULSE_COUNT, new TypeInfo(ValueType.NUMBER));

    // Water Meter
    typeMap.put(
        ChannelType.WATER_METER_VOLUME_CM,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_METRE, UNITS_CUBED)));
    typeMap.put(
        ChannelType.WATER_METER_VOLUME_CFT,
        new TypeInfo(ValueType.NUMBER.withUnits(UNITS_FOOT, UNITS_CUBED)));
    typeMap.put(
        ChannelType.WATER_METER_VOLUME_GAL, new TypeInfo(ValueType.NUMBER, units(UNITS_GALLON)));
    ...
    typeMap.put(
        ChannelType.GENERAL_PURPOSE_ALARM,
        new TypeInfo(ValueType.BOOLEAN, null, ValueFormat.BOOLEAN_ON_OFF()));
    typeMap.put(
        ChannelType.SMOKE_ALARM,
        new TypeInfo(ValueType.BOOLEAN, null, ValueFormat.BOOLEAN_ON_OFF()));
    typeMap.put(
        ChannelType.CO_ALARM, new TypeInfo(ValueType.BOOLEAN, null, ValueFormat.BOOLEAN_ON_OFF()));
    typeMap.put(
        ChannelType.CO2_ALARM, new TypeInfo(ValueType.BOOLEAN, null, ValueFormat.BOOLEAN_ON_OFF()));
    typeMap.put(
        ChannelType.HEAT_ALARM,
        new TypeInfo(ValueType.BOOLEAN, null, ValueFormat.BOOLEAN_ON_OFF()));
    typeMap.put(
        ChannelType.WATER_LEAK_ALARM,
        new TypeInfo(ValueType.BOOLEAN, null, ValueFormat.BOOLEAN_ON_OFF()));
    typeMap.put(
        ChannelType.FIRST_SUPPORTED_ALARM,
        new TypeInfo(ValueType.BOOLEAN, null, ValueFormat.BOOLEAN_ON_OFF()));

    // COMMAND_CLASS_BATTERY

    typeMap.put(
        ChannelType.CHARGE_PERCENTAGE, new TypeInfo(ValueType.NUMBER, units(UNITS_PERCENTAGE)));
