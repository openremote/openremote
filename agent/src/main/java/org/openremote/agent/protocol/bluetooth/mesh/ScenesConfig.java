...
public class ScenesConfig extends ExportConfig {
  ...
  /**
   * Use this class to configure all Scenes. Exported scenes will not contain addresses of excluded
   * nodes.
   */
  ...
  /**
   * Use this class to configure when exporting the related Scenes, the scenes will not contain
  ...
  public static class ExportSome implements Builder {
    ...
    /**
     * Constructs ExportSome to export only a selected number of Scenes when exporting a mesh
     * network. The scenes will not contain addresses of excluded nodes.
     *
