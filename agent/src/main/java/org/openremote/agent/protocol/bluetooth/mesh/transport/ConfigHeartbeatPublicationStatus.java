...
public class ConfigHeartbeatPublicationStatus extends ConfigStatusMessage {
  ...
  public static final Logger LOG =
      Logger.getLogger(ConfigHeartbeatPublicationStatus.class.getName());
  ...
  void parseStatusParameters() {
    ...
    final Features features =
        new Features(
            DeviceFeatureUtils.getFriendFeature(featuresInt),
    ...
    heartbeatPublication =
        new HeartbeatPublication(
            dst, (byte) countLog, (byte) periodLog, ttl, features, netKeyIndex);
