...
public class SerialAgent extends IOAgent<SerialAgent, SerialProtocol, DefaultAgentLink> {
  ...
  public static final AgentDescriptor<SerialAgent, SerialProtocol, DefaultAgentLink> DESCRIPTOR =
      new AgentDescriptor<>(SerialAgent.class, SerialProtocol.class, DefaultAgentLink.class);
