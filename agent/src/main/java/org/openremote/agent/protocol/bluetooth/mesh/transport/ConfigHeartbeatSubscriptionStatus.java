...
public class ConfigHeartbeatSubscriptionStatus extends ConfigStatusMessage {
  ...
  public static final Logger LOG =
      Logger.getLogger(ConfigHeartbeatSubscriptionStatus.class.getName());
  ...
  void parseStatusParameters() {
    ...
    heartbeatSubscription =
        new HeartbeatSubscription(
            srcAddress, dstAddress, (byte) periodLog, (byte) countLog, minHops, maxHops);
