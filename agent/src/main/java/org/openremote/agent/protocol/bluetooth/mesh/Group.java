...
public class Group {
     ...
     */
    public Group(final int id, final int address, final UUID addressLabel, final int parentAddress,
            final UUID parentAddressLabel, final String meshUuid) throws IllegalArgumentException {
     ...
     *
     * @param address Address of the group
     * @param parentAddress Parent address of the group. If there is no parent group use
     *            {@link MeshAddress#UNASSIGNED_ADDRESS}
     * @param meshUuid UUID of the mesh network
     */
    ...
    public Group(final UUID addressLabel, final UUID parentAddressLabel, final String meshUuid)
            throws IllegalArgumentException {
        this(MeshAddress.UNASSIGNED_ADDRESS, addressLabel, MeshAddress.UNASSIGNED_ADDRESS, parentAddressLabel,
                meshUuid);
    }
     ...
     */
    private Group(final int address, final UUID addressLabel, final int parentAddress, final UUID parentAddressLabel,
    ...
    private void generateParentAddressLabel(final UUID parentAddressLabel, final int parentAddress)
        ...
        if (parentAddressLabel == null) {
            if (MeshAddress.isValidVirtualAddress(parentAddress)) {
                ...
                throw new IllegalArgumentException(
                        "parentAddress value must be a group address, " + "virtual address or an unassigned address");
            }
