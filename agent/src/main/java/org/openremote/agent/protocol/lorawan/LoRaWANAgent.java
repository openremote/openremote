...
@Entity
public abstract class LoRaWANAgent<
        T extends LoRaWANAgent<T, U>, U extends AbstractLoRaWANProtocol<U, T>>
    extends Agent<T, U, MQTTAgentLink> {

  public static final AttributeDescriptor<String> MQTT_HOST =
      new AttributeDescriptor<>("MQTTHost", ValueType.HOSTNAME_OR_IP_ADDRESS).withOptional(false);
  public static final AttributeDescriptor<Integer> MQTT_PORT =
      new AttributeDescriptor<>("MQTTPort", ValueType.PORT).withOptional(false);
  ...
  public static final AttributeDescriptor<String> APPLICATION_ID =
      new AttributeDescriptor<>("applicationId", ValueType.TEXT);
