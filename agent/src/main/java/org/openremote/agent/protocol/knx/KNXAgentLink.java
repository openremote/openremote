...
public class KNXAgentLink extends AgentLink<KNXAgentLink> {
  ...
  @NotNull @Pattern(regexp = "^\\d{1,3}\\.\\d{1,3}$") protected String dpt;

  @Pattern(regexp = "^\\d{1,3}/\\d{1,3}/\\d{1,3}$") protected String actionGroupAddress;

  @Pattern(regexp = "^\\d{1,3}/\\d{1,3}/\\d{1,3}$") protected String statusGroupAddress;
