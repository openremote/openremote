...
public class PublicationSettings {
  ...
  /**
   * Sets the credential flags true if friendship credentials is to be used or false if master
   * credentials flags must be used.
   *
  ...
  /**
   * Returns the resolution bit-field of publication steps. The resolution can be 100ms, 1 second,
