...
public class Features {
    ...
    //
    public Features(/* @FeatureState */ final int friend, /* @FeatureState */ final int lowPower,
            /* @FeatureState */ final int proxy, /* @FeatureState */ final int relay) {
        this.friend = friend;
    ...
    public String toString() {
        return "Features{" + "friend=" + friend + ", lowPower=" + lowPower + ", proxy=" + proxy + ", relay=" + relay
                + '}';
    }
