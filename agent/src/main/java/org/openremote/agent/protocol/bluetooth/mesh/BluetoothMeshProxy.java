...
public class BluetoothMeshProxy extends BluetoothCentralManagerCallback {
  ...
  public static final Logger LOG =
      SyslogCategory.getLogger(SyslogCategory.PROTOCOL, BluetoothMeshProxy.class.getName());
  ...
  public static final UUID MESH_PROXY_DATA_IN =
      UUID.fromString("00002ADD-0000-1000-8000-00805F9B34FB");
  ...
  public BluetoothMeshProxy(
    ...
    this.stateMachine =
        new BluetoothMeshProxyStateMachine(
            this,
            central,
            executorService,
  ...
  private class BluetoothPeripheralCallbackImpl extends BluetoothPeripheralCallback {
    ...
    public void onServicesDiscovered(
        final BluetoothPeripheral peripheral, List<BluetoothGattService> services) {
      LOG.info(
          "BluetoothPeripheralCallback::onServicesDiscovered: [Name="
              + peripheral.getName()
              + ", Address="
    ...
    public void onNotificationStateUpdate(
      ...
      LOG.info(
          "BluetoothPeripheralCallback::onNotificationStateUpdate: [Name="
              + peripheral.getName()
              + ", Address="
              + peripheral.getAddress()
              + ", Status="
    ...
    public void onCharacteristicUpdate(
        ...
        BluetoothCommandStatus status) {
      LOG.info(
          "BluetoothPeripheralCallback::onCharacteristicUpdate: [Name="
              + peripheral.getName()
              + ", Address="
              + peripheral.getAddress()
              + ", Status="
    ...
    public void onCharacteristicWrite(
        ...
        BluetoothCommandStatus status) {
      LOG.info(
          "BluetoothPeripheralCallback::onCharacteristicWrite: [Name="
              + peripheral.getName()
              + ", Address="
              + peripheral.getAddress()
              + ", Status="
    ...
    public void onDescriptorRead(
        ...
        BluetoothCommandStatus status) {
      LOG.info(
          "BluetoothPeripheralCallback::onDescriptorRead: [Name="
              + peripheral.getName()
              + ", Address="
              + peripheral.getAddress()
              + ", Status="
    ...
    public void onDescriptorWrite(
        ...
        BluetoothCommandStatus status) {
      LOG.info(
          "BluetoothPeripheralCallback::onDescriptorWrite: [Name="
              + peripheral.getName()
              + ", Address="
              + peripheral.getAddress()
              + ", Status="
    ...
    public void onBondingStarted(BluetoothPeripheral peripheral) {
      LOG.info(
          "BluetoothPeripheralCallback::onBondingStarted: [Name="
              + peripheral.getName()
              + ", Address="
              + peripheral.getAddress()
              + "]");
    ...
    public void onBondingSucceeded(BluetoothPeripheral peripheral) {
      LOG.info(
          "BluetoothPeripheralCallback::OnBondingSucceeded: [Name="
              + peripheral.getName()
              + ", Address="
              + peripheral.getAddress()
              + "]");
    ...
    public void onBondingFailed(BluetoothPeripheral peripheral) {
      LOG.info(
          "BluetoothPeripheralCallback::onBondingFailed: [Name="
              + peripheral.getName()
              + ", Address="
              + peripheral.getAddress()
              + "]");
    ...
    public void onBondLost(BluetoothPeripheral peripheral) {
      LOG.info(
          "BluetoothPeripheralCallback::onBondLost: [Name="
              + peripheral.getName()
              + ", Address="
              + peripheral.getAddress()
              + "]");
    ...
    public void onReadRemoteRssi(
        BluetoothPeripheral peripheral, int rssi, BluetoothCommandStatus status) {
      LOG.info(
          "BluetoothPeripheralCallback::onReadRemoteRssi: [Name="
              + peripheral.getName()
              + ", Address="
              + peripheral.getAddress()
              + ", RSSI="
