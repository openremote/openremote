...
public class BluetoothMeshProxy extends BluetoothCentralManagerCallback {
    ...
    public static final Logger LOG = SyslogCategory.getLogger(SyslogCategory.PROTOCOL,
            BluetoothMeshProxy.class.getName());
    ...
    public BluetoothMeshProxy(MainThreadManager bluetoothCommandSerializer, ExecutorService executorService,
            ScheduledExecutorService scheduledExecutorService, BluetoothCentralManager central,
        ...
        this.stateMachine = new BluetoothMeshProxyStateMachine(this, central, executorService, scheduledExecutorService,
                bluetoothCommandSerializer, peripheral, peripheralCallback);
    }
    ...
    private class BluetoothPeripheralCallbackImpl extends BluetoothPeripheralCallback {
        ...
        public void onServicesDiscovered(final BluetoothPeripheral peripheral, List<BluetoothGattService> services) {
            LOG.info("BluetoothPeripheralCallback::onServicesDiscovered: [Name=" + peripheral.getName() + ", Address="
        ...
        public void onNotificationStateUpdate(BluetoothPeripheral peripheral,
            ...
            LOG.info("BluetoothPeripheralCallback::onNotificationStateUpdate: [Name=" + peripheral.getName()
                    + ", Address=" + peripheral.getAddress() + ", Status=" + status + "]");
        ...
        public void onCharacteristicUpdate(BluetoothPeripheral peripheral, byte[] value,
                BluetoothGattCharacteristic characteristic, BluetoothCommandStatus status) {
            LOG.info("BluetoothPeripheralCallback::onCharacteristicUpdate: [Name=" + peripheral.getName() + ", Address="
        ...
        public void onCharacteristicWrite(BluetoothPeripheral peripheral, byte[] value,
                BluetoothGattCharacteristic characteristic, BluetoothCommandStatus status) {
            LOG.info("BluetoothPeripheralCallback::onCharacteristicWrite: [Name=" + peripheral.getName() + ", Address="
                    + peripheral.getAddress() + ", Status=" + status + "]");
            stateMachine.onCharacteristicWrite(peripheral, value, characteristic, status);
        }

        public void onDescriptorRead(BluetoothPeripheral peripheral, byte[] value, BluetoothGattDescriptor descriptor,
                BluetoothCommandStatus status) {
            LOG.info("BluetoothPeripheralCallback::onDescriptorRead: [Name=" + peripheral.getName() + ", Address="
                    + peripheral.getAddress() + ", Status=" + status + "]");
        }

        public void onDescriptorWrite(BluetoothPeripheral peripheral, byte[] value, BluetoothGattDescriptor descriptor,
                BluetoothCommandStatus status) {
            LOG.info("BluetoothPeripheralCallback::onDescriptorWrite: [Name=" + peripheral.getName() + ", Address="
                    + peripheral.getAddress() + ", Status=" + status + "]");
        }

        public void onBondingStarted(BluetoothPeripheral peripheral) {
            LOG.info("BluetoothPeripheralCallback::onBondingStarted: [Name=" + peripheral.getName() + ", Address="
                    + peripheral.getAddress() + "]");
        }

        public void onBondingSucceeded(BluetoothPeripheral peripheral) {
            LOG.info("BluetoothPeripheralCallback::OnBondingSucceeded: [Name=" + peripheral.getName() + ", Address="
                    + peripheral.getAddress() + "]");
        }

        public void onBondingFailed(BluetoothPeripheral peripheral) {
            LOG.info("BluetoothPeripheralCallback::onBondingFailed: [Name=" + peripheral.getName() + ", Address="
                    + peripheral.getAddress() + "]");
        }

        public void onBondLost(BluetoothPeripheral peripheral) {
            LOG.info("BluetoothPeripheralCallback::onBondLost: [Name=" + peripheral.getName() + ", Address="
                    + peripheral.getAddress() + "]");
        }

        public void onReadRemoteRssi(BluetoothPeripheral peripheral, int rssi, BluetoothCommandStatus status) {
            LOG.info("BluetoothPeripheralCallback::onReadRemoteRssi: [Name=" + peripheral.getName() + ", Address="
                    + peripheral.getAddress() + ", RSSI=" + rssi + ", Status=" + status + "]");
        }
    }
}
