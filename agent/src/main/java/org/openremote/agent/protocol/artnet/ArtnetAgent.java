...
public class ArtnetAgent extends IOAgent<ArtnetAgent, ArtnetProtocol, DefaultAgentLink> {
  ...
  public static final AgentDescriptor<ArtnetAgent, ArtnetProtocol, DefaultAgentLink> DESCRIPTOR =
      new AgentDescriptor<>(ArtnetAgent.class, ArtnetProtocol.class, DefaultAgentLink.class);
