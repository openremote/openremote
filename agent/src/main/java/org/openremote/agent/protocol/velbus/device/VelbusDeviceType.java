...
public enum VelbusDeviceType {
  ...
  @SafeVarargs
  VelbusDeviceType(
      int code, boolean hasSubAddresses, Class<? extends FeatureProcessor>... featureProcessors) {
    this.code = code;
                ...
                processors.computeIfAbsent(
                    ...
                    clazz -> {
                      try {
                        ...
                        LOG.log(
                            Level.SEVERE,
                            "Failed to instantiate feature processor: " + clazz.getSimpleName(),
                            e);
                        return null;
                      }
                    }))
