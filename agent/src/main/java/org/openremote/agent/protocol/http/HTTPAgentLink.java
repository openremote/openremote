...
public class HTTPAgentLink extends AgentLink<HTTPAgentLink> {
  ...
  @JsonPropertyDescription(
      "A JSON object of headers to be added to HTTP request; the key represents the name of the header and for each string value"
          + " supplied a new header will be added with the key name and specified string value")
  protected Map<String, List<String>> headers;

  @JsonPropertyDescription(
      "A JSON object of query parameters to be added to HTTP request URL; the key represents the name of the query parameter and for each string value"
  ...
  @JsonPropertyDescription(
      "Indicates that this HTTP request is used to update the linked attribute; this value indicates how frequently the HTTP request is made in order"
