...
public class TradfriAgent extends Agent<TradfriAgent, TradfriProtocol, DefaultAgentLink> {
  ...
  public static final AgentDescriptor<TradfriAgent, TradfriProtocol, DefaultAgentLink> DESCRIPTOR =
      new AgentDescriptor<>(TradfriAgent.class, TradfriProtocol.class, DefaultAgentLink.class);

  /** The security code for the IKEA TRÅDFRI gateway. */
  public static final AttributeDescriptor<String> SECURITY_CODE =
      new AttributeDescriptor<>("securityCode", ValueType.TEXT);
