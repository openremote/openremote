...
public class GenericOnOffSet extends GenericMessage {
   ...
   */
  public GenericOnOffSet(final ApplicationKey appKey, final boolean state, final int tId)
  ...
  void assembleMessageParameters() {
    ...
    if (mTransitionSteps == null || mTransitionResolution == null || mDelay == null) {
      paramsBuffer =
          ByteBuffer.allocate(GENERIC_ON_OFF_SET_PARAMS_LENGTH).order(ByteOrder.LITTLE_ENDIAN);
      ...
      paramsBuffer =
          ByteBuffer.allocate(GENERIC_ON_OFF_SET_TRANSITION_PARAMS_LENGTH)
