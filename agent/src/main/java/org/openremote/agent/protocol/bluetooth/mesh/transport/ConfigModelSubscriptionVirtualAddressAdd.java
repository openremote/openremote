...
public final class ConfigModelSubscriptionVirtualAddressAdd extends ConfigMessage {
  ...
  public static final Logger LOG =
      Logger.getLogger(ConfigModelSubscriptionVirtualAddressAdd.class.getName());
  private static final int OP_CODE =
      ConfigMessageOpCodes.CONFIG_MODEL_SUBSCRIPTION_VIRTUAL_ADDRESS_ADD;

  // Length in bytes
  private static final int CONFIG_MODEL_SUBSCRIPTION_VIRTUAL_ADDRESS_ADD_PARAMS_LENGTH = 20;
  private static final int VENDOR_MODEL_SUBSCRIPTION_VIRTUAL_ADDRESS_ADD_PARAMS_LENGTH =
      CONFIG_MODEL_SUBSCRIPTION_VIRTUAL_ADDRESS_ADD_PARAMS_LENGTH + 2;
   ...
   */
  public ConfigModelSubscriptionVirtualAddressAdd(
  ...
  void assembleMessageParameters() {
    ...
    if (mModelIdentifier >= Short.MIN_VALUE && mModelIdentifier <= Short.MAX_VALUE) {
      paramsBuffer =
          ByteBuffer.allocate(CONFIG_MODEL_SUBSCRIPTION_VIRTUAL_ADDRESS_ADD_PARAMS_LENGTH)
      ...
      paramsBuffer =
          ByteBuffer.allocate(VENDOR_MODEL_SUBSCRIPTION_VIRTUAL_ADDRESS_ADD_PARAMS_LENGTH)
              .order(ByteOrder.LITTLE_ENDIAN);
      paramsBuffer.put(elementAddress[1]);
      paramsBuffer.put(elementAddress[0]);
      paramsBuffer.put(subscriptionAddress);
