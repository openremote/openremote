...
/**
 * Contains the configuration required when exporting a selected number of mesh nodes in a mesh
 * network.
 */
public class NodesConfig extends ExportConfig {
  ...
  public static class ExportSome implements Builder {
    ...
    /**
     * Constructs ExportSome to export only a selected number of Nodes when exporting a mesh
     * network.
     *
