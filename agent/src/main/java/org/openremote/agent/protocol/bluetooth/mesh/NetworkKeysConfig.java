...
/**
 * Contains the configuration required when exporting a selected number of Network Keys in a mesh
 * network.
 */
public class NetworkKeysConfig extends ExportConfig {
  ...
  public static class ExportSome implements Builder {
    ...
    /**
     * Constructs ExportSome to export only a selected number of network keys when exporting a mesh
     * network.
     *
