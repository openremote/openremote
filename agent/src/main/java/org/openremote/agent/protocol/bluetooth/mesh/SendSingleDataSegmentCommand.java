...
public class SendSingleDataSegmentCommand implements SendDataCommand {
  ...
  public static final Logger LOG =
      SyslogCategory.getLogger(
          SyslogCategory.PROTOCOL, SendSingleDataSegmentCommand.class.getName());
  ...
  public SendSingleDataSegmentCommand(
  ...
  public boolean sendData() {
    ...
    LOG.info(
        "Sending '" + data.length + "' bytes to mesh proxy: [data=" + dataAsHexString(data) + "]");
