...
public enum InputOOBAction {
  ...
  private static final Logger LOG =
      java.util.logging.Logger.getLogger(InputOOBAction.class.getName());
   ...
   */
  public static byte[] generateInputOOBAuthenticationValue(
      final InputOOBAction inputOOBAction, final byte[] input) {
   ...
   * @param size oob size
   */
  public static byte[] getInputOOOBAuthenticationValue(
      final short inputOOBAction, final byte size) {
