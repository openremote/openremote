...
public class ConfigKeyRefreshPhaseSet extends ConfigMessage {
  ...
  private final /* @KeyRefreshPhaseTransition */ int transition;
   ...
   */
  public ConfigKeyRefreshPhaseSet(
      final NetworkKey networkKey, /* @KeyRefreshPhaseTransition */ final int transition) {
    mNetKey = networkKey;
  ...
  void assembleMessageParameters() {
    ...
    mParameters =
        new byte[] {netKeyIndex[1], (byte) ((netKeyIndex[0] & 0xFF) & 0x0F), (byte) transition};
  }
}
