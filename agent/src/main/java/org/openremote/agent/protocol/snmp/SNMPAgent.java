...
public class SNMPAgent extends Agent<SNMPAgent, SNMPProtocol, SNMPAgentLink> {
    ...
    public static final AttributeDescriptor<String> SNMP_BIND_HOST = BIND_HOST.withRequired(true);
    public static final AttributeDescriptor<Integer> SNMP_BIND_PORT = BIND_PORT.withRequired(true);
