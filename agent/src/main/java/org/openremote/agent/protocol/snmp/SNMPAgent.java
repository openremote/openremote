...
public class SNMPAgent extends Agent<SNMPAgent, SNMPProtocol, SNMPAgentLink> {
    ...
    public static final ValueDescriptor<SNMPVersion> VALUE_SNMP_VERSION = new ValueDescriptor<>("SNMPVersion",
            SNMPVersion.class);

    public static final AttributeDescriptor<SNMPVersion> SNMP_VERSION = new AttributeDescriptor<>("SNMPVersionValue",
            VALUE_SNMP_VERSION);
