...
public class UDPAgent extends IOAgent<UDPAgent, UDPProtocol, DefaultAgentLink> {
  ...
  public static final AgentDescriptor<UDPAgent, UDPProtocol, DefaultAgentLink> DESCRIPTOR =
      new AgentDescriptor<>(UDPAgent.class, UDPProtocol.class, DefaultAgentLink.class);
