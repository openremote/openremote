...
public class WebsocketAgent
  ...
  public static final ValueDescriptor<WebsocketSubscription>
      WEBSOCKET_SUBSCRIPTION_VALUE_DESCRIPTOR =
          new ValueDescriptor<>("websocketSubscription", WebsocketSubscription.class);

  /** Websocket connect endpoint URI */
  public static final AttributeDescriptor<String> CONNECT_URL =
      new AttributeDescriptor<>("connectURL", ValueType.WS_URL);

  /** Headers for websocket connect call */
  public static final AttributeDescriptor<ValueType.MultivaluedStringMap> CONNECT_HEADERS =
      new AttributeDescriptor<>("connectHeaders", ValueType.MULTIVALUED_TEXT_MAP);

  /**
   * Array of {@link WebsocketSubscription}s that should be executed once the websocket connection
   * is established; the subscriptions are executed in the order specified in the array.
   */
  public static final AttributeDescriptor<WebsocketSubscription[]> CONNECT_SUBSCRIPTIONS =
   ...
   */
  public static final AttributeDescriptor<Boolean> PING_DISABLED =
      new AttributeDescriptor<>("pingDisabled", ValueType.BOOLEAN);

  public static final AgentDescriptor<WebsocketAgent, WebsocketAgentProtocol, WebsocketAgentLink>
      DESCRIPTOR =
          new AgentDescriptor<>(
