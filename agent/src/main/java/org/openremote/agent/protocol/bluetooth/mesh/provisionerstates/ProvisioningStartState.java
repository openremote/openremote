...
public class ProvisioningStartState extends ProvisioningState {
  ...
  public void executeSend() {
    ...
    mMeshProvisioningStatusCallbacks.onProvisioningStateChanged(
        mNode, States.PROVISIONING_START, provisioningStartPDU);
  ...
  public void setProvisioningCapabilities(
