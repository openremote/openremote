 ...
 *
 * <p>This message lists all subscription addresses for a SIG Models
 */
@SuppressWarnings({"unused", "WeakerAccess"})
public class ConfigVendorModelSubscriptionList extends ConfigStatusMessage {

  public static final Logger LOG =
      Logger.getLogger(ConfigVendorModelSubscriptionList.class.getName());
  ...
  final void parseStatusParameters() {
    ...
    mModelIdentifier =
        MeshParserUtils.bytesToInt(
            new byte[] {mParameters[4], mParameters[3], mParameters[6], mParameters[5]});
