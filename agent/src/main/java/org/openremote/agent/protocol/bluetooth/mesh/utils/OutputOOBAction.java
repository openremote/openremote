...
public enum OutputOOBAction {
  ...
  private static final Logger LOG =
      java.util.logging.Logger.getLogger(OutputOOBAction.class.getName());
  ...
  public static List<OutputOOBAction> parseOutputActionsFromBitMask(final int outputAction) {
    final OutputOOBAction[] outputActions = {
      BLINK, BEEP, VIBRATE, OUTPUT_NUMERIC, OUTPUT_ALPHA_NUMERIC
    };
   ...
   * @param input input
   */
  public static byte[] generateOutputOOBAuthenticationValue(
      final OutputOOBAction outputActionType, final String input) {
