...
public class GroupsConfig extends ExportConfig {
   ...
   * configuration will only contain those groups that any exported model is subscribed or
   * publishing to
   */
  ...
  public static class ExportSome implements Builder {
    ...
    /**
     * Constructs ExportSome to export only a selected number of Groups when exporting a mesh
     * network. Excluded groups will also be excluded from subscription lists and publish
     * information in exported Models.
     *
