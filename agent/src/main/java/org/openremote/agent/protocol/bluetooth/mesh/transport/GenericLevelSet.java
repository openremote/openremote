...
public class GenericLevelSet extends GenericMessage {
   ...
   */
  public GenericLevelSet(final ApplicationKey appKey, final int level, final int tId)
  ...
  void assembleMessageParameters() {
    ...
    if (mTransitionSteps == null || mTransitionResolution == null || mDelay == null) {
      paramsBuffer =
          ByteBuffer.allocate(GENERIC_LEVEL_SET_PARAMS_LENGTH).order(ByteOrder.LITTLE_ENDIAN);
      ...
      paramsBuffer =
          ByteBuffer.allocate(GENERIC_LEVEL_SET_TRANSITION_PARAMS_LENGTH)
