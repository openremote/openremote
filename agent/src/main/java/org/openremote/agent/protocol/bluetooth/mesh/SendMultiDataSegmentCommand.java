...
public class SendMultiDataSegmentCommand implements SendDataCommand {
  ...
  public static final Logger LOG =
      SyslogCategory.getLogger(
          SyslogCategory.PROTOCOL, SendMultiDataSegmentCommand.class.getName());
  ...
  public SendMultiDataSegmentCommand(
  ...
  private List<SendSingleDataSegmentCommand> createCommands(
      int mtuSize,
      ExecutorService executorService,
      BluetoothGattCharacteristic characteristic,
      byte[] data,
    ...
    for (int i = 0; i < numOfSegments; i++) {
      ...
      SendSingleDataSegmentCommand cmd =
          new SendSingleDataSegmentCommand(
              meshProxy,
              commandSerializer,
              executorService,
              characteristic,
              segmentData, /* callback */
              null);
      commandList.add(cmd);
    }
