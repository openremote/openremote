...
class MeshProvisioningHandler implements InternalProvisioningCallbacks {
     ...
     */
    MeshProvisioningHandler(final InternalTransportCallbacks mInternalTransportCallbacks,
            final InternalMeshManagerCallbacks internalMeshManagerCallbacks) {
    ...
    private void parseProvisioningState(final UnprovisionedMeshNode unprovisionedMeshNode, final byte[] data) {
        ...
        if (data[1] == ProvisioningState.State.PROVISIONING_COMPLETE.getState()) {
            ...
            // Generate the network id and store it in the mesh node, this is needed to reconnect to the device at a
            // later stage.
            ...
            mStatusCallbacks.onProvisioningCompleted(provisionedMeshNode,
                    ProvisioningState.States.PROVISIONING_COMPLETE, data);
        } else {
            ...
            if (provisioningFailedState.parseData(data)) {
                mStatusCallbacks.onProvisioningFailed(unprovisionedMeshNode,
                        ProvisioningState.States.PROVISIONING_FAILED, data);
            }
        }
    }
     ...
     */
    private UnprovisionedMeshNode initializeMeshNode(final UUID uuid, final NetworkKey networkKey, final int flags,
            final int ivIndex, final int globalTtl) throws IllegalArgumentException {
    ...
    private boolean validateProvisioningDataInput(final NetworkKey networkKey, final Integer flags,
     ...
     * <p>
     * This method will send a provisioning invite to the connected peripheral. This will help users to identify a
     * particular node before starting the provisioning process.
     ...
     */
    void identify(final UUID uuid, final NetworkKey networkKey, final int flags, final int ivIndex, final int globalTtl,
            final int attentionTimer) throws IllegalArgumentException {
        confirmationInputs = null;
        this.attentionTimer = (byte) attentionTimer;
        final UnprovisionedMeshNode unprovisionedMeshNode = initializeMeshNode(uuid, networkKey, flags, ivIndex,
                globalTtl);
     ...
     * <p>
     * This method will continue the provisioning process that was started by invoking
     * {@link #identify(UUID, NetworkKey, int, int, int, int)}.
     * </p>
     *
     * @param unprovisionedMeshNode {@link UnprovisionedMeshNode}
     */
    void startProvisioningNoOOB(final UnprovisionedMeshNode unprovisionedMeshNode) throws IllegalArgumentException {
     ...
     * @param unprovisionedMeshNode {@link UnprovisionedMeshNode}
     */
    void startProvisioningWithStaticOOB(final UnprovisionedMeshNode unprovisionedMeshNode)
     ...
     */
    void startProvisioningWithOutputOOB(final UnprovisionedMeshNode unprovisionedMeshNode, final OutputOOBAction action)
            throws IllegalArgumentException {
     ...
     */
    void startProvisioningWithInputOOB(final UnprovisionedMeshNode unprovisionedMeshNode, final InputOOBAction action)
            throws IllegalArgumentException {
    ...
    private void sendProvisioningInvite(final UnprovisionedMeshNode unprovisionedMeshNode) {
        isProvisioningPublicKeySent = false;
        isProvisioneePublicKeyReceived = false;
        final ProvisioningInviteState invite = new ProvisioningInviteState(unprovisionedMeshNode, attentionTimer,
     ...
     */
    private boolean parseProvisioningCapabilitiesMessage(final UnprovisionedMeshNode unprovisionedMeshNode,
            final byte[] capabilities) {
        final ProvisioningCapabilitiesState provisioningCapabilitiesState = new ProvisioningCapabilitiesState(
                unprovisionedMeshNode, mStatusCallbacks);
    ...
    private void sendProvisioningStart(final UnprovisionedMeshNode unprovisionedMeshNode) {
        ...
        final ProvisioningStartState startProvisioning = new ProvisioningStartState(unprovisionedMeshNode,
                mInternalTransportCallbacks, mStatusCallbacks);
        startProvisioning.setProvisioningCapabilities(capabilities.getNumberOfElements(),
                capabilities.getRawAlgorithm(), capabilities.getRawPublicKeyType(), capabilities.getRawStaticOOBType(),
                capabilities.getOutputOOBSize(), capabilities.getRawOutputOOBAction(), capabilities.getInputOOBSize(),
    ...
    private void sendProvisioningStartWithInputOOB(final UnprovisionedMeshNode unprovisionedMeshNode,
            final InputOOBAction action) {
        final ProvisioningCapabilitiesState capabilitiesState = (ProvisioningCapabilitiesState) provisioningState;
        final ProvisioningCapabilities capabilities = capabilitiesState.getCapabilities();
    ...
    private void sendProvisionerPublicKey(final UnprovisionedMeshNode unprovisionedMeshNode) {
        if (!isProvisioningPublicKeySent) {
            if (provisioningState instanceof ProvisioningPublicKeyState) {
                ...
                final ProvisioningPublicKeyState provisioningPublicKeyState = new ProvisioningPublicKeyState(
                        unprovisionedMeshNode, mInternalTransportCallbacks, mStatusCallbacks);
            ...
            if (isProvisioningPublicKeySent && isProvisioneePublicKeyReceived) {
                switch (unprovisionedMeshNode.getAuthMethodUsed()) {
                    case STATIC_OOB_AUTHENTICATION:
                        provisioningState = new ProvisioningConfirmationState(this, unprovisionedMeshNode,
                                mInternalTransportCallbacks, mStatusCallbacks);
                        mStatusCallbacks.onProvisioningStateChanged(mUnprovisionedMeshNode,
                                ProvisioningState.States.PROVISIONING_AUTHENTICATION_STATIC_OOB_WAITING, data);
                        break;
                    case OUTPUT_OOB_AUTHENTICATION:
                        provisioningState = new ProvisioningConfirmationState(this, unprovisionedMeshNode,
                                mInternalTransportCallbacks, mStatusCallbacks);
                        mStatusCallbacks.onProvisioningStateChanged(mUnprovisionedMeshNode,
                                ProvisioningState.States.PROVISIONING_AUTHENTICATION_OUTPUT_OOB_WAITING, data);
                        break;
                    case INPUT_OOB_AUTHENTICATION:
                        provisioningState = new ProvisioningInputCompleteState(unprovisionedMeshNode,
                                mInternalTransportCallbacks, mStatusCallbacks);
                        mStatusCallbacks.onProvisioningStateChanged(mUnprovisionedMeshNode,
                                ProvisioningState.States.PROVISIONING_AUTHENTICATION_INPUT_OOB_WAITING, data);
                        break;
                    default:
                        provisioningState = new ProvisioningConfirmationState(this, unprovisionedMeshNode,
                                mInternalTransportCallbacks, mStatusCallbacks);
     ...
     *
     * @param authentication authentication value input by the user this may be nullable depending on the OOB type
    ...
    void sendProvisioningConfirmation(/* @Nullable */ final String authentication) {
        ...
        // Check if the current provisioning state, if the user had selected InputOOBAction the state will be
        // ProvisioningInputCompleteState
        if (provisioningState instanceof ProvisioningInputCompleteState) {
            provisioningConfirmationState = new ProvisioningConfirmationState(this, mUnprovisionedMeshNode,
                    mInternalTransportCallbacks, mStatusCallbacks);
    ...
    private void sendRandomConfirmationPDU(final UnprovisionedMeshNode unprovisionedMeshNode) {
        final ProvisioningRandomConfirmationState provisioningRandomConfirmation = new ProvisioningRandomConfirmationState(
                this, unprovisionedMeshNode, mInternalTransportCallbacks, mStatusCallbacks);
    ...
    private void sendProvisioningData(final UnprovisionedMeshNode unprovisionedMeshNode) {
        final ProvisioningDataState provisioningDataState = new ProvisioningDataState(this, unprovisionedMeshNode,
                mInternalTransportCallbacks, mStatusCallbacks);
    ...
    public final byte[] generateConfirmationInputs(final byte[] provisionerKeyXY, final byte[] provisioneeKeyXY) {
        ...
        final int length = invite.length + capabilities.length + startData.length + provisionerKeyXY.length
