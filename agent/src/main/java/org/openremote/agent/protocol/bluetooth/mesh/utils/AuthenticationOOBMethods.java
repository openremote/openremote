...
public enum AuthenticationOOBMethods {
  // Selecting one of the authentication methods defined below during the provisioning process will
  // require the user to,

  // - Nothing
  NO_OOB_AUTHENTICATION((short) 0),
  // - enter a 16-bit value provided by the device manufacturer to be entered during hte
  // provisioning process
  STATIC_OOB_AUTHENTICATION((short) 1),
  // - enter the number of times the device blinked, beeped, vibrated, displayed or an alphanumeric
  // value displayed by the device
