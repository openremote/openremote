...
public class ZWaveSerialIOClient extends SerialIOClient<byte[]> implements TransportLayer {
  ...
  private static final Logger log =
      SyslogCategory.getLogger(SyslogCategory.PROTOCOL, ZWaveCommandBuilder.ZWAVE_LOG_CATEGORY);
      ...
      switch (connectionStatus) {
        case CONNECTING:
          listener.onConnectionStatusChanged(
              org.openremote.protocol.zwave.port.ConnectionStatus.CONNECTING);
          break;
        case CONNECTED:
          listener.onConnectionStatusChanged(
              org.openremote.protocol.zwave.port.ConnectionStatus.CONNECTED);
          break;
        case DISCONNECTING:
          listener.onConnectionStatusChanged(
              org.openremote.protocol.zwave.port.ConnectionStatus.DISCONNECTING);
          break;
        case DISCONNECTED:
          listener.onConnectionStatusChanged(
              org.openremote.protocol.zwave.port.ConnectionStatus.DISCONNECTED);
          break;
        case ERROR:
          listener.onConnectionStatusChanged(
              org.openremote.protocol.zwave.port.ConnectionStatus.ERROR);
          break;
      }
    }
  }
