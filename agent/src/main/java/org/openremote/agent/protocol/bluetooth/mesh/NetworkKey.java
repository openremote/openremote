...
public final class NetworkKey extends MeshKey {
  ...
  /**
   * Updates the currently used {@link #key} with the newKey and sets the currently used key as the
   * {@link #oldKey}
   *
   * @param newKey New NetworkKey value
   * @return true if successful or false otherwise
   * @throws IllegalArgumentException if a NetworkKey distribution is attempted twice with different
   *     key values during a single Key refresh procedure
   */
