...
public interface MeshManagerCallbacks {
   ...
   *
   * <p>This callback is invoked for every message that was sent or received as it changes the
   ...
   *
   * <p>This is used to get the supported mtu size from the ble module, so that the messages that
   * are larger than the supported mtu size could be segmented
   *
   * @return mtu size
   */
  int getMtu();
