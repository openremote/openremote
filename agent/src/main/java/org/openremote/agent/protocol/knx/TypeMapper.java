...
public class TypeMapper {
    ...
    public static Object toValue(Datapoint datapoint, byte[] data) throws Exception {
        ...
        LOG.info("Received KNX data: " + translator.getType().getID() + " (" + translator.getType().getDescription()
                + ") is " + translator.getValue() + " (" + translator.getNumericValue() + ") - " + datapoint.getName());
