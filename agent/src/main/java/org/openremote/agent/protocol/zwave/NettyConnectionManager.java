...
public class NettyConnectionManager extends DefaultZWConnectionManager {
  ...
  public static NettyConnectionManager create(
      ZWavePortConfiguration configuration, ZWaveSerialIOClient messageProcessor) {
  ...
  protected NettyConnectionManager(
      ZWavePortConfiguration configuration, ZWaveSerialIOClient ioClient) {
    super(configuration);
