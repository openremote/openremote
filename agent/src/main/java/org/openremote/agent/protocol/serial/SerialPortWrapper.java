...
/**
 * Interface for serial port wrappers to allow shared access management.
 * Implementations can be either exclusive (direct jSerialComm) or shared (via SerialPortManager).
 */
