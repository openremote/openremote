...
public class SimulatorAgentProtocolScheduleTest {
    ...
    public void advanceToNextOccurrence() {
        ...
        assertEquals(-3600, schedule.advanceToNextOccurrence(0));
        assertEquals(0, schedule.advanceToNextOccurrence(3600));
        assertEquals(400, schedule.advanceToNextOccurrence(4000));
        ...
        assertEquals(3600, schedule.advanceToNextOccurrence(now + 3600));
        assertEquals(0, schedule.advanceToNextOccurrence(now + 86400));
        assertEquals(0, schedule.advanceToNextOccurrence(now + 86400*2));
        assertEquals(0, schedule.advanceToNextOccurrence(now + 86400*3));
        assertEquals(0, schedule.advanceToNextOccurrence(now + 86400*4));
        assertEquals(1, schedule.advanceToNextOccurrence(now + 86400*4+1));
        assertEquals(86400-1, schedule.advanceToNextOccurrence(now + 86400*5-1));
        ...
        assertEquals(0, schedule.advanceToNextOccurrence(now + 86400));
        // Surpassed
        assertEquals(86400, schedule.advanceToNextOccurrence(now + 86400*2));
    }
