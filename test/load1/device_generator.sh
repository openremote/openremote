...
CA_KEY_PATH=../test/src/test/resources/org/openremote/test/provisioning/ca.key
CA_PEM_PATH=../test/src/test/resources/org/openremote/test/provisioning/ca.pem
