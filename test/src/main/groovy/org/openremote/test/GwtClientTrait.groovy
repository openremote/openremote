...
trait GwtClientTrait {
    ...
    static class CollectingEventListener implements EventListener<Event> {
        List<SharedEvent> collectedEvents

        CollectingEventListener(List<SharedEvent> collectedEvents) {
    ...
    static EventBus createEventBus(List<SharedEvent> collectedEvents) {
