...
/**
 * Mock Serial Channel for testing serial-based protocols without actual hardware. Extends
 * OioByteStreamChannel just like JSerialCommChannel. This channel simulates a serial port by using
 * in-memory queues for data transfer. Tests can configure a {@link DataHandler} to process outgoing
