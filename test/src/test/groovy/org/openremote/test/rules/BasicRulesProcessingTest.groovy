...
class BasicRulesProcessingTest extends Specification implements ManagerContainerTrait {
    ...
    def "Handle attribute event with no meta, asset create, update, delete"() {
        ...
        conditions.eventually {
            assert rulesService.attributeInfos.size() == DEMO_RULE_STATES_GLOBAL + 1
        ...
        conditions.eventually {
            assert rulesService.attributeInfos.size() == DEMO_RULE_STATES_GLOBAL
        ...
        conditions.eventually {
            assert rulesService.attributeInfos.size() == DEMO_RULE_STATES_GLOBAL + 2
