...
class NotificationTest extends Specification implements ManagerContainerTrait {
    ...
    def "Check push notification functionality"() {
        ...
        def notifications = adminNotificationResource.getNotifications(null, null, null, null, null, [testuser2Console.id, testuser3Console1.id, testuser3Console2.id, anonymousConsole.id])
