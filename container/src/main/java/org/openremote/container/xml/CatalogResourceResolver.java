 ...
 *
 * <p>Of course it's just a map, like so many others in the JAXP hell. But this time someone really
 * went all out on the API fugliness. The person who designed this probably got promoted and is now
 * designing the signaling system for the airport you are about to land on. Feeling better?
 */
  ...
  public LSInput resolveResource(
    ...
    LOG.info(
        "System identifier not found in catalog, continuing with default resolution "
            + "(this most likely means remote HTTP request!): "
            + systemId);
    return null;
  }
