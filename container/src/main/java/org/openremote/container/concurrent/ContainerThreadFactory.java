...
/**
 * Creates daemon-threads with {@link Thread#NORM_PRIORITY} and a sensible name (prefix plus
 * incrementing number) in the security manager's thread group or if there is no security manager,
 * in the calling thread's group.
 */
