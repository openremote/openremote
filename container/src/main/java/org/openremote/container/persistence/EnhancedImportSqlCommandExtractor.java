...
/**
 * Load and parse import SQL files, either the whole file as a single statement if its first line is
 * <code>-- importOneStatementOnly</code>, or as a semicolon-separated list of statements.
 */
