...
public class PersistenceHealthStatusProvider implements HealthStatusProvider {
    ...
    public Object getHealthStatus() {
        ...
        try {
            ...
            return Map.<String, Object> of("idleConnections", idleConnections, "activeConnections", activeConnections,
                    "totalConnections", totalConnections, "threadsWaiting", threadsWaiting);
