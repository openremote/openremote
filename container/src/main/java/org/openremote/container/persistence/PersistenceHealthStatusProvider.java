...
public class PersistenceHealthStatusProvider implements HealthStatusProvider {
  ...
  private static final Logger LOG =
      Logger.getLogger(PersistenceHealthStatusProvider.class.getName());
  ...
  public Object getHealthStatus() {
    ...
    String poolNameStr =
        persistenceService.persistenceUnitProperties.containsKey(PROPERTY_POOL_NAME)
