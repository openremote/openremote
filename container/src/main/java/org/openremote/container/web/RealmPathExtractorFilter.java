...
/**
 * A servlet {@link Filter} that removes the realm from the full request path at the specified path
 * segment index and adds it as a {@link org.openremote.model.Constants#REALM_PARAM_NAME} request
 * header. If the {@link org.openremote.model.Constants#REALM_PARAM_NAME} header is already set,
          ...
          public StringBuffer getRequestURL() {
            ...
            try {
              ...
              return new StringBuffer(
                  original.substring(0, original.indexOf(super.getRequestURI())) + getRequestURI());
            }
          }
        };
