 ...
 * {@link jakarta.ws.rs.client.Client} that uses a connection pool and has the following {@link
 * jakarta.ws.rs.ext.ContextResolver}s registered (additional filters etc. should be registered on
 * the {@link WebTargetBuilder} instances):
 *
 * <ul>
 *   <li>{@link org.openremote.container.json.JacksonConfig}.
 * </ul>
 */
// TODO: This should probably be amalgamated with WebClient somehow to provide a unified JAX-RS
// Client API and a default
    ...
    RequestConfig requestConfig =
        RequestConfig.custom()
            ...
            .setConnectionRequestTimeout(
                Long.valueOf(CONNECTION_CHECKOUT_TIMEOUT_MILLISECONDS).intValue())
