...
public class RequestLogger implements ContainerRequestFilter {
    ...
    public static final System.Logger REQUEST_LOG = System
            .getLogger(RequestLogger.class.getName() + "." + SyslogCategory.API.name());
    ...
    public void filter(ContainerRequestContext requestContext) throws IOException {
        REQUEST_LOG.log(System.Logger.Level.DEBUG, () -> {
            ...
            return "Client request '" + method + " " + requestPath + " (responseType=" + responseType
                    + ")', requestRealm=" + realm + ", username=" + usernameAndRealm + ", origin=" + address + ":"
                    + port + ", forwarded-for=" + forwardedAddress;
        });
    }
}
