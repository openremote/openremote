...
public interface KeycloakResource {
  ...
  AccessTokenResponse getAccessToken(
      @PathParam("realm") String realm, @BeanParam PasswordAuthForm authForm);
  ...
  @Produces(APPLICATION_JSON)
  AccessTokenResponse getAccessToken(
      @PathParam("realm") String realm, @BeanParam ClientCredentialsAuthForm authForm);
  ...
  AdapterConfig getAdapterConfig(
      @PathParam("realm") String realm, @PathParam("clientId") String clientId);
}
