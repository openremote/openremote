...
public abstract class BasicIdentityProvider implements IdentityProvider {
    ...
    protected static class BasicFixAuthenticationMechanism extends BasicAuthenticationMechanism {
        ...
        protected static class Factory implements AuthenticationMechanismFactory {
            ...
            public AuthenticationMechanism create(String mechanismName, IdentityManager identityManager,
                ...
                return new BasicFixAuthenticationMechanism(realm, mechanismName,
                        silent != null && silent.equals("true"), identityManager, charset, userAgentCharsets);
            }
        }
        ...
        public BasicFixAuthenticationMechanism(String realmName, String mechanismName, boolean silent,
                IdentityManager identityManager, Charset charset, Map<Pattern, Charset> userAgentCharsets) {
    ...
    public void init(Container container) {
        ...
        this.persistenceService.getDefaultSchemaLocations()
    ...
    protected Account verifyAccount(String username, char[] password) {
        ...
        final BasicAuthContext principal = new BasicAuthContext(Constants.MASTER_REALM, idAndPassword[0].toString(),
                username);
        return new Account() {
            @Override
