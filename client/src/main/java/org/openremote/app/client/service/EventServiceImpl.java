...
import org.openremote.app.client.event.session.*;
import org.openremote.app.client.util.Timeout;
...
public class EventServiceImpl implements EventService {
    ...
    public void connect() {
        ...
        appSecurity.authorizeUrl(serviceUrl, authorizedServiceUrl -> {

            webSocket = Browser.getWindow().newWebSocket(authorizedServiceUrl);
