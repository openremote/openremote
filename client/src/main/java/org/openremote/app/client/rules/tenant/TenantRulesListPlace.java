...
public class TenantRulesListPlace extends RulesPlace {
    ...
    @Prefix("tenantRules")
    public static class Tokenizer implements PlaceTokenizer<TenantRulesListPlace> {

        @Override
        public TenantRulesListPlace getPlace(String token) {
            return new TenantRulesListPlace(token != null && token.length() > 0 ? token : null);
        }
