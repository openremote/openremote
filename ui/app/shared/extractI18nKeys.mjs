...
const response = await fetch("http://localhost:8080/api/master/model/valueDescriptors");
...
async function processDescriptor(name, props, localesDir) {
  ...
  const response = await fetch(
    `http://localhost:8080/api/master/model/getValueDescriptorSchema?version=latest&descriptorType=${
      props.type
