...
import ReadMe from "./temp/or-asset-viewer-README.md";

const { events, args, argTypes, template } = getWcStorybookHelpers("or-asset-viewer");

const meta: Meta<OrAssetViewer> = {
    title: "Components/or-asset-viewer",
...
type Story = StoryObj<OrAssetViewer & typeof args>;
...
async function loadOrAssetViewer(args: any): Promise<HTMLElement | undefined> {
