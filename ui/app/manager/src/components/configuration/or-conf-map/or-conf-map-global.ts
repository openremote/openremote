      ...
      <div class="map-tile-settings">
        ...
        <div class="map-tile-upload-group">
          ...
          <span>
            ...
            <or-translate
              class="note"
              value="configuration.global.uploadMapTilesNote"
          ...
          <div class="input d-inline-flex" style="height: 56px">
            <div id="fileupload" style="display: flex; align-items: center">
              <or-mwc-input
                outlined
                label="selectFile"
                style="width: fit-content; padding-right: 12px;"
                .type="${InputType.BUTTON}"
                @or-mwc-input-changed="${() => this.shadowRoot.getElementById("fileupload-elem").click()}"
              >
                <input
                  id="fileupload-elem"
                  name="configfile"
                  type="file"
                  accept=".mbtiles"
                  @change="${this.notifyMapFileChange}"
                />
              </or-mwc-input>
              <or-mwc-input
                id="filename-elem"
      ...
      <div class="map-style-settings">
        ...
        <div class="map-style-layers-group">
          ...
          <div style="display: flex; gap: 12px; align-items: center">
            ...
            <or-conf-json
              class="input fit-content hide-mobile"
              .heading="${i18next.t("configuration.global.mapLayers")}"
