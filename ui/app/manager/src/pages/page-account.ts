 ...
 */
import { css, html, type TemplateResult, unsafeCSS, type CSSResult } from "lit";
...
import { ClientRole, type Credential, type Role, type User, type UserAssetLink, UserQuery } from "@openremote/model";
...
export class PageAccount extends Page<AppStateKeyed> {
    ...
    return html`
            <div id="wrapper">
                ...
                <div id="content" class="panel">
                    ...
                    ${guard([this._user, this._language], () =>
                      until(
                      ...
                      <div class="row">
                        <div class="column">
                          <or-vaadin-button
                            ...
                            @click=${() => manager.login({ action: "CONFIGURE_TOTP" })}
                          >
   ...
   */
  protected async _getAccountRowTemplate(
    user?: UserModel,
    readonly = true,
    onchange?: (user: User, dirty: boolean, invalid: boolean) => void
