...
// import {Alarm, AlarmSeverity, AlarmStatus, ClientRole, Role, UserQuery} from "@openremote/model";
...
// }
//
// interface AlarmModel extends Alarm {
//     loaded?: boolean;
//     createdOn?: Date;
//     title?: String;
//     content?: String;
...
//             {title: i18next.t('severity')},
//             {title: i18next.t('status')}
//         ];
//         const activeAlarmTableRows: TableRow[] = this._activeAlarms.map((alarm) => {
//             return {
//                 content: [alarm.createdOn, alarm.title, alarm.content, alarm.severity, alarm.status],
//                 clickable: true
//             }
//         });
//
...
//     }
//
//     protected getSingleUserView(alarm: AlarmModel, readonly: boolean = true): TemplateResult {
//         return html`
//             ${when((alarm.loaded), () => {
