...
export class OrImageWidget implements OrWidgetEntity {
    ...
    // Properties
    readonly DISPLAY_NAME: string = "Image Map";
    ...
    getDefaultConfig(widget: DashboardWidget): ImageWidgetConfig {
        return {
...
@customElement('or-image-map-widget')
    ...
    render() {
        ...
        return html`
            <div style="height: 100%; display: flex; flex-direction: column; overflow: hidden;">
                <or-map id="miniMap" class="or-image-map" .zoom="${this.widget?.widgetConfig?.zoom}"
...
class OrImageWidgetSettings extends LitElement {
