...
`;
let OrDashboardBrowser = class OrDashboardBrowser extends LitElement {
    static get styles() {
    ...
    renderGrid() {
        var _a, _b;
        const sidebarElement = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.getElementById("sidebarElement");
        const coords = new Array([0, 0], [2, 0], [0, 2], [2, 2], [0, 4], [2, 4], [0, 6], [2, 6], [0, 8], [2, 8]); // TODO: make this unlimited possibilities with a formula
        const sidebarItems = Array.from(widgetTypes)
        ...
        if (this.sidebarGrid !== undefined) {
            ...
            this.sidebarGrid.on('removed', (_event, items) => {
                var _a;
                if (items.length === 1) {
                    const filteredItems = sidebarItems.filter(widget => {
                        return (widget.content === items[0].content);
                    });
                    (_a = this.sidebarGrid) === null || _a === void 0 ? void 0 : _a.load([filteredItems[0]]);
                }
            });
            // On any change, recreate the grid to prevent users moving Sidebar items around.
            // @ts-ignore typechecking since we assume they are not undefined
            this.sidebarGrid.on('change', (_event, _items) => {
                this.renderGrid();
            });
        }
        // Seperate Static Background grid (to make it look like the items duplicate)
        const sidebarBgElement = (_b = this.shadowRoot) === null || _b === void 0 ? void 0 : _b.getElementById("sidebarBgElement");
...
__decorate([
    state()
], OrDashboardBrowser.prototype, "sidebarGrid", void 0);
__decorate([
    state()
], OrDashboardBrowser.prototype, "backgroundGrid", void 0);
OrDashboardBrowser = __decorate([
    customElement("or-dashboard-browser")
], OrDashboardBrowser);
export { OrDashboardBrowser };
//# sourceMappingURL=or-dashboard-browser.js.map