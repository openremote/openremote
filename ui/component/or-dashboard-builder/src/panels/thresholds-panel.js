...
export class ThresholdChangeEvent extends CustomEvent {
...
ThresholdChangeEvent.NAME = "threshold-change";
export class TextColorsChangeEvent extends CustomEvent {
    constructor(textColors) {
...
TextColorsChangeEvent.NAME = "text-colors-change";
export class BoolColorsChangeEvent extends CustomEvent {
...
BoolColorsChangeEvent.NAME = "bool-colors-change";
const styling = css `
...
`;
let ThresholdsPanel = class ThresholdsPanel extends LitElement {
    constructor() {
        super(...arguments);
        this.thresholds = [];
        this.textColors = [];
    ...
    render() {
        return html `
            ...
            || this.valueType === 'negativeNumber') ? html `
                    ${this.thresholds.sort((x, y) => (x[0] < y[0]) ? -1 : 1).map((threshold, index) => {
            return html `
            ...
            this.requestUpdate('boolColors');
                ...
                ${(this.valueType === 'text' && this.textColors) ? html `
                    ${this.textColors.map((threshold, index) => {
            return html `
                            <div class="threshold-list-item">
                                <div class="threshold-list-item-colour">
                                    <or-mwc-input type="${InputType.COLOUR}" value="${threshold[1]}"
    ...
    removeThreshold(threshold) {
        switch (typeof threshold[0]) {
            case "number":
                this.thresholds = this.thresholds.filter((x) => x !== threshold);
                break;
            default:
                this.textColors = this.textColors.filter((x) => x !== threshold);
                break;
        }
    }
    addThreshold(threshold) {
        switch (typeof threshold[0]) {
            case "number":
                ...
                break;
            default:
                this.textColors.push(threshold);
                this.requestUpdate('textColors');
                break;
        }
    }
    addNewThreshold() {
        ...
        this.updateComplete.then(() => {
            var _a;
            const elem = (_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.getElementById('thresholds-list');
            const inputField = Array.from(elem.children)[elem.children.length - 2];
            inputField.children[1].setAttribute('focused', 'true');
        });
    }
};
__decorate([
    property()
], ThresholdsPanel.prototype, "thresholds", void 0);
__decorate([
    property()
], ThresholdsPanel.prototype, "textColors", void 0);
__decorate([
    property()
], ThresholdsPanel.prototype, "boolColors", void 0);
__decorate([
    property()
], ThresholdsPanel.prototype, "min", void 0);
__decorate([
    property()
], ThresholdsPanel.prototype, "max", void 0);
__decorate([
    property()
], ThresholdsPanel.prototype, "valueType", void 0);
ThresholdsPanel = __decorate([
    customElement("thresholds-panel")
], ThresholdsPanel);
export { ThresholdsPanel };
//# sourceMappingURL=thresholds-panel.js.map