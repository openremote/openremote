...
import type { OrVaadinConfirmDialog } from "../src/or-vaadin-confirm-dialog";
...
const meta: Meta = {
  ...
  parameters: {
    ...
    docs: {
      subtitle: `<${tagName}>`,
      description:
        "Confirm Dialog is a modal Dialog used to confirm user actions. Compared to other components, users can not dismiss this dialog.",
    },
  },
};
...
export const Primary: Story = {
  render: (_args) => {
    return html`
      ...
      <or-vaadin-button
        @click="${() => (document.querySelector("or-vaadin-confirm-dialog") as OrVaadinConfirmDialog).open()}"
