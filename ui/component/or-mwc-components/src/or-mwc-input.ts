            ...
            switch (this.type) {
                ...
                case InputType.JSON_OBJECT: {
                    ...
                    if (!(this.type === InputType.RANGE && this.disableSliderNumberInput)) {
                        ...
                        if(this.censure) type = InputType.PASSWORD;
                        ...
                        inputElem = html`
                            <label id="${componentId}" class="${classMap(classes)}">
                                ...
                                ${this.type === InputType.PASSWORD && !this.censure ? html`<or-icon class="mdc-text-field__icon mdc-text-field__icon--trailing" aria-hidden="true" icon=${this.advertised ? 'eye' : 'eye-off'} style="pointer-events: auto;" @click=${() => this.advertised = !this.advertised}></or-icon>` : ``}
