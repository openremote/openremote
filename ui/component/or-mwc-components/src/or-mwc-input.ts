...
import {
    ...
    MetaHolder, NameValueHolder,
    ValueConstraintAllowedValues,
    ValueConstraintFuture,
    ValueConstraintFutureOrPresent, ValueConstraintMax, ValueConstraintMin,
    ValueConstraintNotBlank,
    ValueConstraintNotEmpty,
    ValueConstraintNotNull, ValueConstraintPast, ValueConstraintPastOrPresent, ValueConstraintPattern,
    ValueConstraintSize,
    ValueFormatStyleRepresentation, WellknownMetaItems, WellknownValueTypes
} from "@openremote/model";
import type {AssetDescriptor, NameHolder,
    ValueConstraint, ValueDescriptor, ValueDescriptorHolder, ValueFormat, ValueHolder} from "@openremote/model";
