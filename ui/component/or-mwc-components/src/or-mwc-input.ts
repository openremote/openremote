...
import {ValueFormatStyleRepresentation} from "@openremote/model";
import type {AssetDescriptor, NameHolder, ValueDescriptor, ValueDescriptorHolder, ValueFormat, ValueHolder} from "@openremote/model";
