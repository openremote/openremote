...
import { getValueHolderInputTemplateProvider } from "@openremote/or-mwc-components/or-mwc-input";
...
export class OrAttributeInputChangedEvent extends CustomEvent {
...
OrAttributeInputChangedEvent.NAME = "or-attribute-input-changed";
export function getAttributeInputWrapper(content, value, loading, disabled, helperText, label, buttonIcon, sendValue, fullWidth) {
    if (helperText) {
        content = html `
    ...
    if (buttonIcon) {
        content = html `
                ${content}
                <or-mwc-input id="send-btn" icon="${buttonIcon}" type="button" .disabled="${disabled || loading}" @or-mwc-input-changed="${(e) => {
            e.stopPropagation();
            if (sendValue) {
                sendValue();
            }
...
export function getHelperText(sending, error, timestamp) {
    if (sending) {
...
export const jsonFormsInputTemplateProvider = (fallback) => (assetDescriptor, valueHolder, valueHolderDescriptor, valueDescriptor, valueChangeNotifier, options) => {
    const disabled = !!(options && options.disabled);
    const readonly = !!(options && options.readonly);
    const label = options.label;
    // Agent link needs some special handling as we need an agent picker no matter what
    if (valueDescriptor.name === "agentLink" /* WellknownValueTypes.AGENTLINK */) {
        // Apply a custom UI schema to remove the outer VerticalLayout
        const uiSchema = { type: "Control", scope: "#" };
        let schema;
        const jsonForms = createRef();
        const loadingWrapper = createRef();
        let loadedAgents = [];
        let initialised = false;
        let agentLink;
        const onAgentLinkChanged = (dataAndErrors) => {
            if (!initialised) {
                return;
            }
            const newAgentLink = dataAndErrors.data;
            if (newAgentLink) {
                const agent = loadedAgents.find((agnt) => agnt.id === newAgentLink.id);
                if (agent) {
                    const newAgentDescriptor = AssetModelUtil.getAssetDescriptor(agent.type);
        ...
        const doLoad = (link) => __awaiter(void 0, void 0, void 0, function* () {
            if (!initialised) {
                agentLink = link;
            }
            initialised = true;
...
let OrAttributeInput = class OrAttributeInput extends subscribe(manager)(translate(i18next)(LitElement)) {
    constructor() {
        super(...arguments);
    ...
    shouldUpdate(_changedProperties) {
        ...
        if (_changedProperties.has("attribute")) {
            const oldAttr = Object.assign({}, _changedProperties.get("attribute"));
    ...
    _updateTemplate() {
        ...
        const valueChangeHandler = (detail) => {
        ...
        if (valueDescriptor.name === "GEO_JSONPoint" /* WellknownValueTypes.GEOJSONPOINT */) {
    ...
    isReadonly() {
        if (!manager.hasRole("write:attributes" /* ClientRole.WRITE_ATTRIBUTES */)) {
            this.readonly = !manager.hasRole("write:attributes" /* ClientRole.WRITE_ATTRIBUTES */);
            return this.readonly;
        }
        return this.readonly !== undefined ? this.readonly : Util.getMetaValue("readOnly" /* WellknownMetaItems.READONLY */, this.attribute, this._attributeDescriptor);
    }
    render() {
    ...
    _onAttributeValueChanged(oldValue, newValue, timestamp) {
        if (this.attribute) {
    ...
    _onInputValueChanged(value, updateImmediately) {
...
], OrAttributeInput.prototype, "attribute", void 0);
__decorate([
    property({ type: String })
], OrAttributeInput.prototype, "assetId", void 0);
__decorate([
    property({ type: Object })
], OrAttributeInput.prototype, "attributeDescriptor", void 0);
__decorate([
    property({ type: Object })
], OrAttributeInput.prototype, "valueDescriptor", void 0);
__decorate([
    property({ type: String })
], OrAttributeInput.prototype, "assetType", void 0);
__decorate([
    property({ type: String })
], OrAttributeInput.prototype, "label", void 0);
__decorate([
    property({ type: Boolean })
], OrAttributeInput.prototype, "disabled", void 0);
__decorate([
    property({ type: Boolean })
], OrAttributeInput.prototype, "readonly", void 0);
__decorate([
    property({ type: Boolean, attribute: true })
], OrAttributeInput.prototype, "required", void 0);
__decorate([
    property()
], OrAttributeInput.prototype, "value", void 0);
__decorate([
    property()
], OrAttributeInput.prototype, "inputType", void 0);
__decorate([
    property({ type: Boolean })
], OrAttributeInput.prototype, "hasHelperText", void 0);
__decorate([
    property({ type: Boolean })
], OrAttributeInput.prototype, "disableButton", void 0);
__decorate([
    property({ type: Boolean, attribute: true })
], OrAttributeInput.prototype, "disableSubscribe", void 0);
__decorate([
    property({ type: Boolean })
], OrAttributeInput.prototype, "disableWrite", void 0);
__decorate([
    property({ type: Boolean })
], OrAttributeInput.prototype, "compact", void 0);
__decorate([
    property({ type: Boolean })
], OrAttributeInput.prototype, "comfortable", void 0);
__decorate([
    property({ type: Boolean })
], OrAttributeInput.prototype, "resizeVertical", void 0);
__decorate([
    property({ type: Boolean })
], OrAttributeInput.prototype, "fullWidth", void 0);
__decorate([
    property({ type: Boolean })
], OrAttributeInput.prototype, "rounded", void 0);
__decorate([
    property({ type: Boolean })
], OrAttributeInput.prototype, "outlined", void 0);
__decorate([
    property()
], OrAttributeInput.prototype, "_attributeEvent", void 0);
__decorate([
    property()
], OrAttributeInput.prototype, "_writeTimeoutHandler", void 0);
OrAttributeInput = __decorate([
    customElement("or-attribute-input")
], OrAttributeInput);
export { OrAttributeInput };
