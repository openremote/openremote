...
let OrSmartNotify = class OrSmartNotify extends LitElement {
    ...
    getSmartNotify() {
        ...
        return new Promise((resolve, reject) => {
            ...
            manager.rest.api.AssetResource.queryAssets(smartNotifyQuery).then((response) => {
    ...
    setSmartNotify(e) {
        ...
        manager.rest.api.AssetResource.update(this.smartNotify.id, this.smartNotify).then((response) => {
            console.log("Setting Smart Notify");
    ...
    firstUpdated(_changedProperties) {
        ...
        this.isDisabled = !manager.hasRole("write:assets" /* ClientRole.WRITE_ASSETS */);
    }
};
__decorate([
