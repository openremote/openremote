...
import { getMarkerIconAndColorFromAssetType, type OverrideConfigSettings } from "../util";
...
export function getMarkerConfigForAssetType(
  config: MapMarkerAssetConfig | undefined,
  assetType: string | undefined
): MapMarkerConfig | undefined {
...
export function getMarkerConfigAttributeName(
  config: MapMarkerAssetConfig | undefined,
  assetType: string | undefined
): string | undefined {
...
export class OrMapMarkerAsset extends subscribe(manager)(OrMapMarker) {
  ...
  protected set type(type: string | undefined) {
    ...
    if (
      assetTypeConfig &&
      assetTypeConfig.attributeName &&
      this.asset &&
      this.asset.attributes &&
      this.asset.attributes[assetTypeConfig.attributeName] &&
      assetTypeConfig.colours
    ) {
    ...
    this._markerColor = Array.isArray(iconAndColour.color)
      ? iconAndColour.color[0].colour
      : iconAndColour.color || undefined;
