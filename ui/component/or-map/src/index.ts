        ...
        if (compact) {
            ...
            content = html`
                ...
                <div id="geo-json-point-input-compact-wrapper">
                    <or-mwc-input .comfortable="${comfortable}" .type="${InputType.TEXT}" .value="${centerStr}" .pattern="${CoordinatesRegexPattern}" @keyup="${(e: KeyboardEvent) => getCoordinatesInputKeyHandler(valueChangeHandler)(e)}">
                    </or-mwc-input><or-mwc-input .type="${InputType.BUTTON}" compact icon="crosshairs-gps" @or-mwc-input-changed="${onClick}"></or-mwc-input>
                </div>
            `;
        }
