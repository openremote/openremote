 ...
 */
import { type NodeCollection, type GlobalRuleset, RulesetLang, type Ruleset } from "@openremote/model";
...
export class Exporter {
  ...
  public exportAsExisting(id: number, collection: NodeCollection) {
    ...
    const ruleApi = manager.rest.api.RulesResource;
    ruleApi
      .getGlobalRuleset(project.existingFlowRuleId)
      .then((response) => {
