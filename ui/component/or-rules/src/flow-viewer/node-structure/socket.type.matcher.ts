  ...
  private static readonly matches: { type: NodeDataType; matches: NodeDataType[] }[] = [
    {
      ...
      matches: [NodeDataType.NUMBER, NodeDataType.STRING, NodeDataType.NUMBER_ARRAY],
    },
    {
      type: NodeDataType.STRING,
      matches: [NodeDataType.STRING],
    },
    {
      type: NodeDataType.TRIGGER,
      matches: [NodeDataType.TRIGGER],
    },
    {
      type: NodeDataType.BOOLEAN,
      matches: [NodeDataType.BOOLEAN, NodeDataType.STRING],
    },
    {
      type: NodeDataType.COLOR,
      matches: [NodeDataType.COLOR, NodeDataType.STRING],
    },
    {
      type: NodeDataType.NUMBER_ARRAY,
      matches: [NodeDataType.NUMBER],
    },
  ];
}
