...
import {
  HTTPMethod,
  type OAuthGrant,
  type OAuthClientCredentialsGrant,
  type Webhook,
...
export class OrRuleFormWebhook extends OrElement implements OrRuleForm {
      ...
      () => html`
        <form style="display: flex; flex-direction: column; min-width: 520px;">
          ...
          <div style="display: flex; flex-direction: column; gap: 5px; margin-bottom: 28px;">
            ...
            ${when(
              this.loading,
              () => html` ${this.getHeadersTemplate(this.webhook.headers!, true)} `,
